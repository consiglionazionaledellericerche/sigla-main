 ...
 * @author $Author: apoli $
 * @version $Rev: 10489 $, $Date: 2015-01-13 10:15:51 +0100(mar, 13 gen 2015) $
 */
...
//		}
		...
		try{  
			reader.load(Client.class.getResourceAsStream("/Client.properties")); 
		...
		String xmlFile2Send = Client.getProperty(reader, "file", true);;
		...
		InputStream fin = Client.class.getResourceAsStream(xmlFile2Send);
		...
		if(user!=null && passw!=null){
			...
			authentication = "Basic " + new String( Base64.encodeBase64(authentication.getBytes()));
