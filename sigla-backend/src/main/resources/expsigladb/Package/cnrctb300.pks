...
-- Version: 3.5
--
-- Fix errore interno 2217. Gestione della data di esigibilità iva sulle fatture attive a seguito di
...
-- Date: 21/02/2003
-- Version: 3.7
-- Controllo di non eliminabilità reversale di accantonamento versamento CORI accentrati
--
-- Date: 26/02/2003
-- Version: 3.8
...
-- 3) Il generico è un documento di reintegro fondo
-- 4) Il generico è previsto essere da pagarsi o pagato tramite fondo economale
--
-- Date: 26/03/2003
-- Version: 3.10
--
-- Fix errore CINECA n. 549. Nella associazione tra terzo del mandato e riga del generico si verifica
-- anche l'abbinamento se DOCUMENTO_GENERICO_RIGA.cd_terzo_cessionario non è nullo e coincide con
...
-- Valorizzazione o spegnimento della data di esigibilità differita sulle fatture attive
--
...
--                  Altrimenti
--                       Se il tipo di documento autorizzatorio è 'A' (Accreditamento) o 'R' (Regolarizzazione)  o se
--                       il tipo di documento amministrativo è di reintegro fondo economale o accantonamento di entrata
--                       o spesa (CORI)
...
--                       Altrimenti
--                            Se lo stato COFI del documento è 'P'
...
--                 Se la modalità è di inserimento del documento autorizzatorio
...
--         Se il tipo di documento amministrativo collegato al mandato è un accantonamento di entrata o spesa
--              Viene annullata l'obbligazione o accertamento automatici generati con l'accantonamento:
--               Se il tipo di documento autorizzatorio è 'MAN'
...
-- Pre-post name: Sull base del pg_ver_rec passato verifica se il documento amministrativo è cambiato (dopo averlo letto in modo lockante)
-- pre:   Il pg_ver_rec del documento amministrativo è diverso da quello specificato o quello specificato null o il documento amministrativo non viene trovato
