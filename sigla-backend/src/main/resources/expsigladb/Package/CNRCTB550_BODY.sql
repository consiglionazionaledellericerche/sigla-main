...
BEGIN
  ...
  tabella_date_ok.DELETE;
	...
	OPEN gen_cur FOR
       ...
       FROM COMPENSO,COMPENSO_RIGA,MANDATO,MANDATO_RIGA
       WHERE MANDATO_RIGA.ESERCIZIO_OBBLIGAZIONE = COMPENSO_RIGA.ESERCIZIO_OBBLIGAZIONE
         And   MANDATO_RIGA.ESERCIZIO_ORI_OBBLIGAZIONE = COMPENSO_RIGA.ESERCIZIO_ORI_OBBLIGAZIONE
         And   MANDATO_RIGA.PG_OBBLIGAZIONE = COMPENSO_RIGA.PG_OBBLIGAZIONE
         And   MANDATO_RIGA.PG_OBBLIGAZIONE_SCADENZARIO = COMPENSO_RIGA.PG_OBBLIGAZIONE_SCADENZARIO
