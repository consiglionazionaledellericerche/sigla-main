...
-- Version: 1.21
--
-- Aggiunto controllo di errore in formula se il riferimento ad id_riga nella formula di calcolo   
-- maggiore dello stesso id_riga
--
-- Date: 03/09/2002
-- Version: 1.22
--
-- Aggiunto controllo di errore in formula anche se il riferimento ad id_riga nella formula di calcolo   
-- uguale dello stesso id_riga
--
-- Date: 05/09/2002
-- Version: 1.23
--
...
-- Version: 2.5
--
-- Fix errore CINECA n. 727. Modifica controlli di ammissibilit?el compenso se il totale compenso   
-- maggiore di zero. Si accettano solo i casi in cui il netto calcolato del mandato principale risulta
...
--       modifica (vedi pre-post: Il trattamento indicato non ?ompatibile con l'origine del compenso e Impossibilit  
--       alla attivazione della modifica).
...
--                 Se il trattamento ?nnualizzato di tipo 1, l'importo di accesso a scaglione   
--                      Arrotondamento alla seconda cifra decimale(Imponibile CORI/(Delta in gg periodo di competenza economica del CORI + 1)*365 o 366.
...
--                      codice fiscale per identificare i record che si riferiscono ad uno stesso soggetto; se nullo ogni record   
...
-- post:
--       Vengono letti i dati di base del compenso
--            Se il compenso risulta essere annullato (vedi pre-post-name: Il compenso selezionato risulta essere gi  
--            stato annullato).
