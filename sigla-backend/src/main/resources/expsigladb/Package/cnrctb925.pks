...
-- e nel caso in cui l'aliquota rodotta ? del 15%, l'altra assicurazione obbligatoria valorizzata con '002'.
--
-- Date: 13/01/2006
-- Version: 1.4
--
-- Poich? le righe negative hanno aliquota = 0, con la modifica precedente sono state escluse.
   ...
   BEGIN
      ...
      LOOP
         ...
         If aRecVEstraiDatiInps.ti_ente_percipiente = TICORIENTE Then
            ...
            End If;
            */
            --Aggiunto il comune presso il quale il lavoratore svolge la propria attivit?
            --Se il comune ? in Italia, viene inserito il codice catastale
            --Se il comune ? estero, viene inserito il codice fisco dello stato estero
