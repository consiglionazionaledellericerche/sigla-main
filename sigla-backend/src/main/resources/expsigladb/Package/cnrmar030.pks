...
-- la scadenza ? legata ad una fattura (riga di fattura ) a sua volta associata
-- con un sospeso. Inoltre la fattura in esame risulta avere pi? righe associate
...
-- Date: 21/07/2003
-- Version: 1.25
-- Fix sul caso in cui una fattura passiva risulta legata a pi? obbligazioni
-- o a pi? scadenze di obbligazione
--
-- Date: 21/07/2003
-- Version: 1.26
-- Fix 2 sul caso in cui una fattura passiva risulta legata a pi? obbligazioni
-- o a pi? scadenze di obbligazione
--
-- Date: 12/09/2003
-- Version: 1.27
	   ...
	   for lFatturaPasTestata in (select *
 		   ...
 		   begin
 			   ...
 			   for update nowait;
 		   	   ...
 		   	   -- Vediamo se sulla fattura insisto pi? scadenze di obbligazioni
			   ...
			   if lNumScadObb = 1 or lNumScadObb = 0 then
	 		   	   -- Vediamo se sulla fattura insisto pi? obbligazioni
   	 	   ...
   	 	   if lFatturaLettera then
 		  	  if lFatturaSospeso then
 			  	 if lSommaScadenze then
 				  	...
 				  	-- 3) La fattura in esame risulta avere pi? righe
 				  	...
 				  	-- Vengono per? eseguiti i seguenti controlli
		   ...
		   begin -- livello 2
			    ...
			    loop  -- accertamento
					...
					loop -- accertamento_scadenzario
						 ...
						 -- --------------------------------------------------------------------------------
						 -- MAX -- verificare se in caso che il cds sia ENTE il controllo ? valido
