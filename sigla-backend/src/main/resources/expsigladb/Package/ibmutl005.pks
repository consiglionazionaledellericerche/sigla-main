...
is
	...
	begin
		...
		-- Controllo il tipo di blob ?¨ binario o caratteri
	...
	begin
		...
		begin
			...
			exception
				...
				then
					ibmerr001.RAISE_ERR_GENERICO ( 'File gi?  inserito' );
		end;
			...
			exception
				...
				then
					ShImpostaStato ( aTipo
						       ...
						       , aFilename
						       , gStatoErr );
					ibmerr001.RAISE_ERR_GENERICO ( 'Chiusura Fallita o Blob gi?  chiuso' );
		end;
