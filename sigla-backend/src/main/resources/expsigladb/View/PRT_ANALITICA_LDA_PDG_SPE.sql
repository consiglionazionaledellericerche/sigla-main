...
elemento_voce.TI_APPARTENENZA='D' and
elemento_voce.TI_GESTIONE='S' and
...
;
   ...
   COMMENT ON TABLE "PRT_ANALITICA_LDA_PDG_SPE"  IS 'Vista di estrazione dati dai piani di gestione per le situazioni per lda  Costi/spese';
