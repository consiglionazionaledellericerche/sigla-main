...
--
  cnr_anadip.matricola, cnr_anadip.nominativo,
             ...
             WHERE     anagrafico.codice_fiscale = cnr_anadip.dip_cod_fis and
                    anagrafico.cd_anag                 = terzo.cd_anag and
                    terzo.dt_fine_rapporto is null and
                    anagrafico.cd_anag                 = rapporto.cd_anag and
                    rapporto.matricola_dipendente = cnr_anadip.matricola and
                           unita_organizzativa.cd_unita_organizzativa = SUBSTR (cnr_anadip.tit_afferen, 1, 3)|| '.'|| SUBSTR (cnr_anadip.tit_afferen, 4, 3)
