--------------------------------------------------------
--  DDL for View V_CDP_SPACC_CDR_LA_VOCE_LE3
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "V_CDP_SPACC_CDR_LA_VOCE_LE3" ("ESERCIZIO", "MESE", "CD_CDR_ROOT", "CD_CDR", "TI_APPARTENENZA", "TI_GESTIONE", "CD_ELEMENTO_VOCE", "CD_LINEA_ATTIVITA", "TI_RAPPORTO", "TI_PREV_CONS", "ID_MATRICOLA", "IM_A1", "IM_A2", "IM_A3", "IM_RND_A1", "IM_RND_A2", "IM_RND_A3") AS 
  select
--
-- Date: 08/01/2004
-- Version: 1.1
