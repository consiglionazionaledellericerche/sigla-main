...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_COMPENSO_770" ("CD_CDS", "CD_UNITA_ORGANIZZATIVA", "ESERCIZIO", "PG_COMPENSO", "ESERCIZIO_MANDATO", "CD_ANAG", "CD_TRATTAMENTO", "CD_QUADRO", "DS_QUADRO", "TI_MODELLO", "TI_RITENUTA", "CD_TI_COMPENSO", "DS_TI_COMPENSO", "IM_LORDO_PERCIPIENTE", "IM_NO_FISCALE", "QUOTA_ESENTE", "IM_NETTO_PERCIPIENTE", "QUOTA_ESENTE_INPS", "CD_ANAG_PIGNORATO") AS 
  SELECT
--
-- Date: 11/07/2011
-- Version: 1.0
