...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "PRT_STAMPA_SOSP_CDS" ("ESERCIZIO", "TI_ENTRATA_SPESA", "CD_SOSPESO", "CD_CDS_ORIGINE", "DISPONIBILE", "IM_SOSPESO", "DT_REGISTRAZIONE", "TI_CC_BI", "CAUSALE", "DS_ANAGRAFICO") AS 
  SELECT
  -- Date: 21/10/2003
  -- Version: 1.2
  --
