--------------------------------------------------------
--  DDL for View DIP_DA_CONG_NEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "DIP_DA_CONG_NEW" ("TERZO", "MATRICOLA", "TI_ENTE_PERCIPIENTE", "CD_CONTRIBUTO_RITENUTA", "IMPONIBILE", "AMMONTARE") AS 
  select
  a.CD_TERZO,
...
from compenso a, contributo_ritenuta b, tipo_contributo_ritenuta cr,/* tipo_cr_base c, gruppo_cr_det e,*/
     v_dt_manrev_comp dtm,terzo t, v_rapp_dip r
where
  a.stato_cofi = 'P'
