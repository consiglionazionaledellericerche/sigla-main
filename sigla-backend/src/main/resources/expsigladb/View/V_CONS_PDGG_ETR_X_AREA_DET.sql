--------------------------------------------------------
--  DDL for View V_CONS_PDGG_ETR_X_AREA_DET
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "V_CONS_PDGG_ETR_X_AREA_DET" ("ESERCIZIO", "CD_CDS_AREA", "DS_UNITA_ORGANIZZATIVA", "CD_CDR_ASSEGNATARIO", "DS_CDR", "CD_CLASSIFICAZIONE", "DS_CLASSIFICAZIONE", "NR_LIVELLO", "CD_LIVELLO1", "CD_LIVELLO2", "CD_LIVELLO3", "CD_LIVELLO4", "CD_LIVELLO5", "CD_LIVELLO6", "CD_LIVELLO7", "PG_MODULO", "CD_MODULO", "DS_MODULO", "PG_COMMESSA", "CD_COMMESSA", "DS_COMMESSA", "PG_PROGETTO", "CD_PROGETTO", "DS_PROGETTO", "CD_LINEA_ATTIVITA", "TI_APPARTENENZA", "TI_GESTIONE", "CD_ELEMENTO_VOCE", "DS_ELEMENTO_VOCE", "IM_ENTRATA", "IM_INCASSI") AS 
  SELECT
--
-- Date: 09/11/2006
-- Version: 1.1
...
PDGG.ESERCIZIO, PDGG.CD_CDS_AREA, AREA.DS_UNITA_ORGANIZZATIVA,
       PDGG.CD_CDR_ASSEGNATARIO_CLGE, CDR.DS_CDR,
       ...
       PDGG.IM_ENTRATA,
       PDGG.IM_INCASSI
From   PDG_MODULO_ENTRATE_GEST PDGG, V_CLASSIFICAZIONE_VOCI CLA, UNITA_ORGANIZZATIVA AREA,
...
Where  PDGG.ID_CLASSIFICAZIONE = CLA.ID_CLASSIFICAZIONE AND
       ...
       PDGG.CD_CDR_ASSEGNATARIO_CLGE = CDR.CD_CENTRO_RESPONSABILITA AND
