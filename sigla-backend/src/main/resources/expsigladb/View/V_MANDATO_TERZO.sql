...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_MANDATO_TERZO" ("CD_CDS", "ESERCIZIO", "PG_MANDATO", "CD_UNITA_ORGANIZZATIVA", "CD_CDS_ORIGINE", "CD_UO_ORIGINE", "CD_TIPO_DOCUMENTO_CONT", "TI_MANDATO", "TI_COMPETENZA_RESIDUO", "DS_MANDATO", "STATO", "DT_EMISSIONE", "DT_TRASMISSIONE", "DT_PAGAMENTO", "DT_ANNULLAMENTO", "IM_MANDATO", "IM_PAGATO", "UTCR", "DACR", "UTUV", "DUVA", "PG_VER_REC", "STATO_TRASMISSIONE", "STATO_COGE", "IM_RITENUTE", "DT_RITRASMISSIONE", "CD_TERZO", "CD_ANAG", "DENOMINAZIONE_SEDE", "DT_FIRMA", "STATO_TRASMISSIONE_ANNULLO", "FL_RIEMISSIONE", "DT_FIRMA_ANNULLO", "PG_MANDATO_RIEMISSIONE", "DT_PAGAMENTO_RICHIESTA") AS 
  SELECT
--
--
-- Date: 10/12/2002
