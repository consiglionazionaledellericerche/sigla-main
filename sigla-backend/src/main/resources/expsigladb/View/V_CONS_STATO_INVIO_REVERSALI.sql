...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_CONS_STATO_INVIO_REVERSALI" ("CD_CDS", "ESERCIZIO", "PG_REVERSALE", "CD_UNITA_ORGANIZZATIVA", "TI_REVERSALE", "DS_REVERSALE", "STATO", "IM_REVERSALE", "IM_INCASSATO", "DT_EMIS_REV", "DT_ANNULLAMENTO", "DT_INCASSO", "PG_DISTINTA", "PG_DISTINTA_DEF", "DT_EMIS_DIS", "DT_INVIO_DIS") AS 
...
-- MANDATI IN DISTINTA
   Select reversale.cd_cds, reversale.esercizio, reversale.pg_reversale,
          ...
          distinta_cassiere.dt_invio dt_invio_dis
