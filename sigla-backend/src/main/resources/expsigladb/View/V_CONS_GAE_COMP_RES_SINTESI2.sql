--------------------------------------------------------
--  DDL for View V_CONS_GAE_COMP_RES_SINTESI2
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "V_CONS_GAE_COMP_RES_SINTESI2" ("ESERCIZIO", "CDS", "CDR", "DS_CDR", "LDA", "DS_LDA", "CD_RESPONSABILE_TERZO", "DENOMINAZIONE_SEDE", "CD_ELEMENTO_VOCE", "DS_ELEMENTO_VOCE", "CD_CDS_OBB", "ESERCIZIO_OBBLIGAZIONE", "ESERCIZIO_ORIGINALE", "PG_OBBLIGAZIONE", "PG_OBBLIGAZIONE_SCADENZARIO", "DS_SCADENZA", "IM_IMPEGNI", "CD_CDS_MAN", "PG_MANDATO", "DT_EMISSIONE", "DT_TRASMISSIONE", "DT_PAGAMENTO", "DS_MANDATO", "IM_MANDATI") AS 
  SELECT /*+ optimizer_features_enable('10.1.0') */   
        riepilogo.esercizio,
                                --unita_organizzativa.cd_unita_padre,
                                riepilogo.cd_cds cds,
       ...
       FROM 
-- COMPETENZA
            (SELECT esercizio, cd_centro_responsabilita, cd_cds,
                    cd_linea_attivita, ds_linea_attivita ds_lda,
                    cd_elemento_voce, ds_elemento_voce, cd_cds_obb,
               ...
               FROM v_cons_gae_competenza_spe2
              WHERE cd_cds_obb IS NOT NULL
             UNION
             -- RESIDUI
             SELECT esercizio, cd_centro_responsabilita, cd_cds,
                    cd_linea_attivita, ds_linea_attivita, cd_elemento_voce,
