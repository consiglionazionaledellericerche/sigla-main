--------------------------------------------------------
--  DDL for View PRT_STAMPA_RISCONTRI_MOD
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "PRT_STAMPA_RISCONTRI_MOD" ("CDS", "ESERCIZIO", "TIPOSOSP", "TIPOES", "CODSOSP", "IMPORTO", "DATA", "TIPOBANCA", "CAUS", "DESCR", "UO", "PG_MANREV", "DESC_TERZO", "UO_ORIGINE") AS 
  SELECT
-- Date: 18/05/2004
-- Version: 1.3
--
