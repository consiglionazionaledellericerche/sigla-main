--------------------------------------------------------
--  DDL for View V_CDP_TOT_PRC
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "V_CDP_TOT_PRC" ("ESERCIZIO", "MESE", "CD_UNITA_ORGANIZZATIVA", "ID_MATRICOLA", "PRC_A1", "PRC_A2", "PRC_A3") AS 
  ( SELECT
--
-- Date: 09/03/2006
-- Version: 1.5
...
FROM (
 ...
 CD_UNITA_ORGANIZZATIVA
   ...
   COMMENT ON TABLE "V_CDP_TOT_PRC"  IS 'Totalizza le percentuali dei costi del dipendente configurate
Somma i costi configurati per scarico su PDG (propri) +
        costi configurati verso altra uo confermati';
