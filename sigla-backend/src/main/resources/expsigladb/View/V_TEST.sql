...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_TEST" ("ESERCIZIO", "CD_UTENTE", "CD_UNITA_ORGANIZZATIVA", "CD_ACCESSO", "TI_FUNZIONE", "BUSINESS_PROCESS", "DACR", "UTCR", "DUVA", "UTUV", "PG_VER_REC") AS 
  SELECT
--
-- Date: 28/04/2008
-- Version: 1.5
