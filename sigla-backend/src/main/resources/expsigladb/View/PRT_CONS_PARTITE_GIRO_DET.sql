--------------------------------------------------------
--  DDL for View PRT_CONS_PARTITE_GIRO_DET
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "PRT_CONS_PARTITE_GIRO_DET" ("ESERCIZIO", "TI_ORIGINE", "CD_CDS_OBB", "ESERCIZIO_OBB", "CD_UNITA_ORGANIZZATIVA_OBB", "CD_CDS_ORIGINE_OBB", "CD_UO_ORIGINE_OBB", "DS_UO_ORIGINE_OBB", "CD_ELEMENTO_VOCE_OBB", "DS_ELEMENTO_VOCE_OBB", "ESERCIZIO_ORI_OBBLIGAZIONE", "PG_OBBLIGAZIONE", "IM_SCADENZA_COMP_OBB", "IM_SCADENZA_RES_OBB", "IM_ASSOCIATO_DOC_AMM_COMP_OBB", "IM_ASSOCIATO_DOC_AMM_RES_OBB", "IM_PAGATO_COMP", "IM_PAGATO_RES", "CD_CDS_ACR", "ESERCIZIO_ACR", "CD_UNITA_ORGANIZZATIVA_ACR", "CD_CDS_ORIGINE_ACR", "CD_UO_ORIGINE_ACR", "DS_UO_ORIGINE_ACR", "CD_ELEMENTO_VOCE_ACR", "DS_ELEMENTO_VOCE_ACR", "ESERCIZIO_ORI_ACCERTAMENTO", "PG_ACCERTAMENTO", "IM_SCADENZA_COMP_ACR", "IM_SCADENZA_RES_ACR", "IM_ASSOCIATO_DOC_COMP_ACR", "IM_ASSOCIATO_DOC_RES_ACR", "IM_INCASSATO_COMP", "IM_INCASSATO_RES") AS 
  SELECT
--
-- Date: 18/07/2006
-- Version: 1.0
