...
Decode (SEZIONE,'D',IM_MOVIMENTO,0) IM_MOVIMENTO_DARE,
Decode (SEZIONE,'A',IM_MOVIMENTO,0) IM_MOVIMENTO_AVERE,
NULL DIFFERENZA
...
( SCRITTURA_PARTITA_DOPPIA.PG_SCRITTURA=MOVIMENTO_COGE.PG_SCRITTURA )
 GROUP BY MOVIMENTO_COGE.ESERCIZIO_DOCUMENTO,MOVIMENTO_COGE.CD_TIPO_DOCUMENTO, MOVIMENTO_COGE.CD_CDS_DOCUMENTO,MOVIMENTO_COGE.CD_UO_DOCUMENTO,MOVIMENTO_COGE.PG_NUMERO_DOCUMENTO
 );