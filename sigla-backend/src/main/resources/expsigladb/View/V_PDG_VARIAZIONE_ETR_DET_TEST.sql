--------------------------------------------------------
--  DDL for View V_PDG_VARIAZIONE_ETR_DET_TEST
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "V_PDG_VARIAZIONE_ETR_DET_TEST" ("ESERCIZIO", "CD_CENTRO_RESPONSABILITA", "DS_CDR", "CD_LINEA_ATTIVITA", "DENOMINAZIONE", "DS_LINEA_ATTIVITA", "PG_PROGETTO", "TI_GESTIONE", "CD_ELEMENTO_VOCE", "DS_ELEMENTO_VOCE", "VARIAZIONE", "ASSESTATO_ENTRATA", "STATO", "CD_NATURA", "DS_NATURA", "PG_VARIAZIONE_PDG", "ESERCIZIO_PDG_VARIAZIONE", "CD_CENTRO_RESPONSABILITA_CLGS", "DS_CDR_CLGS", "ID_CLASSIFICAZIONE", "DS_CLASSIFICAZIONE", "TITOLO", "CATEGORIA", "CD_MODULO", "DS_MODULO") AS 
  SELECT
