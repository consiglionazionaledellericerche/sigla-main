...
--
            ...
            SUM (a.importo_ini_residui_propri) importo_ini_residui_propri,
            SUM (a.importo_manrev) importo_manrev,
            SUM (a.assestato_cassa) assestato_cassa
       FROM (SELECT
--
-- Date: 05/05/2006
-- Version: 1.0
                    ...
                    (SELECT NVL
                      ...
                      WHERE var_stanz_res_riga.esercizio =
                        ...
                        AND var_stanz_res.stato = 'PRD')
                                                        variazioni_definitive,
                      NVL (im_obbl_res_pro, 0) importo_ini_residui_propri,
                      NVL (im_mandati_reversali_pro, 0)
                    + NVL (im_mandati_reversali_imp, 0) importo_manrev,
                      NVL (im_stanz_iniziale_cassa, 0) 
                    + NVL (variazioni_piu_cassa, 0) 
                    - NVL (variazioni_meno_cassa, 0) assestato_cassa
               FROM voce_f_saldi_cdr_linea
