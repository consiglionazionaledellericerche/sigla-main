...
from vp_dpdg_etr_ente
;

   COMMENT ON TABLE "VP_DPDG_ENTE"  IS 'Vista di stampa dei dettagli pdg per ENTE: legge parte spesa ed entrata dalle viste da cui dipende';
