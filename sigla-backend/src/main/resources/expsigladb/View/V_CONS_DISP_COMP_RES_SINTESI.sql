...
--------------------------------------------------------
  ...
  SELECT   ESERCIZIO, CDS, CDR, DS_CDR, LDA, DS_LDA, CD_RESPONSABILE_TERZO, (SELECT DENOMINAZIONE_SEDE FROM TERZO WHERE LINEA_ATTIVITA.CD_RESPONSABILE_TERZO = CD_TERZO) DENOMINAZIONE_SEDE, CD_ELEMENTO_VOCE, DS_VOCE, SUM(DISP_COMP), SUM(DISP_RES) 
...
GROUP BY ESERCIZIO, CDS, CDR, DS_CDR, LDA, DS_LDA, CD_RESPONSABILE_TERZO, CD_ELEMENTO_VOCE, DS_VOCE 
