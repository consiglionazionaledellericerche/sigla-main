...
FROM
PRT_REND_FIN_SPESE_CNR_art_ALL
WHERE
(INIZIALE+VAR_PIU+VAR_MENO+ACCREDITAMENTI+INIZIALE_R+VAR_PIU_R+VAR_MENO_R+ACCREDITAMENTI_R)<>0
;

   COMMENT ON TABLE "PRT_REND_FIN_SPESE_ART_CNR"  IS 'Vista di stampa Rendiconto Finanziario CDS Spese (SOLO importi DIVERSI DA zero)';
