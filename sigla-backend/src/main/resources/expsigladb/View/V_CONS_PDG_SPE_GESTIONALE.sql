--------------------------------------------------------
--  DDL for View V_CONS_PDG_SPE_GESTIONALE
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "V_CONS_PDG_SPE_GESTIONALE" ("ESERCIZIO", "PESO_DIP", "CD_DIPARTIMENTO", "CD_CENTRO_SPESA", "CD_UNITA_ORGANIZZATIVA", "CD_CENTRO_RESPONSABILITA", "CD_CDR_ORIGINE_FONDI", "CD_CLASSIFICAZIONE", "NR_LIVELLO", "CD_LIVELLO1", "CD_LIVELLO2", "CD_LIVELLO3", "CD_LIVELLO4", "CD_LIVELLO5", "CD_LIVELLO6", "CD_LIVELLO7", "CD_ELEMENTO_VOCE", "CD_LINEA_ATTIVITA", "PG_MODULO", "CD_MODULO", "CD_TIPO_MODULO", "PG_COMMESSA", "CD_COMMESSA", "PG_PROGETTO", "CD_PROGETTO", "STANZIAMENTO_DEC_INT", "STANZIAMENTO_DEC_EST", "STANZIAMENTO_ACC_INT", "STANZIAMENTO_ACC_EST", "VARIAZIONI_POSITIVE_DEC_INT", "VARIAZIONI_POSITIVE_DEC_EST", "VARIAZIONI_POSITIVE_ACC_INT", "VARIAZIONI_POSITIVE_ACC_EST", "VARIAZIONI_NEGATIVE_DEC_INT", "VARIAZIONI_NEGATIVE_DEC_EST", "VARIAZIONI_NEGATIVE_ACC_INT", "VARIAZIONI_NEGATIVE_ACC_EST") AS 
  Select
--
-- Date: 09/11/2006
-- Version: 1.1
--
-- Vista CONSULTAZIONE Piano di Gestione Gestionale Spese
--
-- History:
--
-- Date: 01/01/2006
...
ESERCIZIO, PESO_DIP, CD_DIPARTIMENTO, CD_CENTRO_SPESA, CD_UNITA_ORGANIZZATIVA,
       ...
       Nvl(Sum(STANZIAMENTO_DEC_INT), 0) STANZIAMENTO_DEC_INT,
       Nvl(Sum(STANZIAMENTO_DEC_EST), 0) STANZIAMENTO_DEC_EST,
       Nvl(Sum(STANZIAMENTO_ACC_INT), 0) STANZIAMENTO_ACC_INT,
       Nvl(Sum(STANZIAMENTO_ACC_EST), 0) STANZIAMENTO_ACC_EST,
...
(Select pdg_modulo_spese_gest.ESERCIZIO, -- DIPARTIMENTI INIZIALE
        ...
        pdg_modulo_spese_gest.CD_CDR_ASSEGNATARIO CD_CENTRO_RESPONSABILITA,
        pdg_modulo_spese_gest.CD_CENTRO_RESPONSABILITA CD_CDR_ORIGINE_FONDI,
        ...
        Nvl(pdg_modulo_spese_gest.IM_SPESE_GEST_DECENTRATA_INT, 0) STANZIAMENTO_DEC_INT,
        Nvl(pdg_modulo_spese_gest.IM_SPESE_GEST_DECENTRATA_EST, 0) STANZIAMENTO_DEC_EST,
        Nvl(pdg_modulo_spese_gest.IM_SPESE_GEST_ACCENTRATA_INT, 0) STANZIAMENTO_ACC_INT,
        Nvl(pdg_modulo_spese_gest.IM_SPESE_GEST_ACCENTRATA_EST, 0) STANZIAMENTO_ACC_EST,
...
Where
 ...
 PROG.cd_dipartimento= p.cd_dipartimento (+) and
  -- join tra PDG_MODULO_SPESE_GEST e ELEMENTO_VOCE
        pdg_modulo_spese_gest.ESERCIZIO                 = elemento_voce.ESERCIZIO
And     pdg_modulo_spese_gest.TI_APPARTENENZA           = elemento_voce.TI_APPARTENENZA
And     pdg_modulo_spese_gest.TI_GESTIONE               = elemento_voce.TI_GESTIONE
And     pdg_modulo_spese_gest.CD_ELEMENTO_VOCE          = elemento_voce.CD_ELEMENTO_VOCE
...
Select  v_cons_pdg_var_gestionale.ESERCIZIO,
        ...
        v_cons_pdg_var_gestionale.CD_CENTRO_RESPONSABILITA CD_CDR_ORIGINE_FONDI,
        ...
        0 STANZIAMENTO_DEC_INT,
        0 STANZIAMENTO_DEC_EST,
        0 STANZIAMENTO_ACC_INT,
        0 STANZIAMENTO_ACC_EST,
...
Where   v_cons_pdg_var_gestionale.TI_GESTIONE = 'S'
...
Group By ESERCIZIO, PESO_DIP, CD_DIPARTIMENTO, CD_CENTRO_SPESA, CD_UNITA_ORGANIZZATIVA,
       ...
       CD_ELEMENTO_VOCE, CD_LINEA_ATTIVITA,
       PG_MODULO, CD_MODULO, CD_TIPO_MODULO, PG_COMMESSA, CD_COMMESSA, PG_PROGETTO, CD_PROGETTO
Having Nvl(Sum(STANZIAMENTO_DEC_INT), 0) != 0 Or Nvl(Sum(STANZIAMENTO_DEC_EST), 0) != 0 Or
       Nvl(Sum(STANZIAMENTO_ACC_INT), 0) != 0 Or Nvl(Sum(STANZIAMENTO_ACC_EST), 0) != 0 Or
