...
CREATE OR REPLACE FORCE VIEW "V_CONTROLLI_PCC" (
    ...
    "DT_EMISSIONE_MAN",
    "IM_MANDATO",
    "CD_TIPO_CONTRATTO" FROM (
        SELECT det.IDENTIFICATIVO_SDI, det.NUMERO_DOCUMENTO, det.DATA_DOCUMENTO, nvl(det2.PRESTATORE_CODICEFISCALE,) CODICE_FISCALE, det2.CODICE_DESTINATARIO, det2.DATA_RICEZIONE,
