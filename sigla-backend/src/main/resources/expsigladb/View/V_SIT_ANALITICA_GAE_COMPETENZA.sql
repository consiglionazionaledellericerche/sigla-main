...
--
          ...
          e.ds_elemento_voce, im_stanz_iniziale_a1, variazioni_piu,
          variazioni_meno,
            NVL (im_stanz_iniziale_a1, 0)
          + NVL (variazioni_piu, 0)
          - NVL (variazioni_meno, 0),
          im_obbl_acc_comp,
            NVL (im_stanz_iniziale_a1, 0)
          + NVL (variazioni_piu, 0)
          - NVL (variazioni_meno, 0)
          - NVL (im_obbl_acc_comp, 0),
          NVL
             ((SELECT SUM (im_voce)
          ...
          NVL (im_obbl_acc_comp, 0) - NVL (im_mandati_reversali_pro, 0)
    ...
    WHERE parametri_cnr.esercizio = vs.esercizio
      ...
      AND e.esercizio = vs.esercizio_res
