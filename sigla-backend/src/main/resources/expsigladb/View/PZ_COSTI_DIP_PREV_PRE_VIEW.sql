--------------------------------------------------------
--  DDL for View PZ_COSTI_DIP_PREV_PRE_VIEW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "PZ_COSTI_DIP_PREV_PRE_VIEW" ("ESERCIZIO", "TI_PREV_CONS", "MATRICOLA", "TI_APPARTENENZA", "TI_GESTIONE", "CD_ELEMENTO_VOCE", "CD_UNITA_ORGANIZZATIVA", "IM_A1", "IM_A2", "IM_A3", "IM_ONERI_CNR_A1", "IM_ONERI_CNR_A2", "IM_ONERI_CNR_A3", "IM_TFR_A1", "IM_TFR_A2", "IM_TFR_A3") AS 
  SELECT  A.anno_gest+1, 
        'P', 
        A.matricola, 
        'D', 
        'S', 
