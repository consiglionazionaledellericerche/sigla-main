...
From PARAMETRI_CNR PAR, V_CLASSIFICAZIONE_VOCI CLA, CDR, PROGETTO_PREV MODU, PROGETTO_PREV COMM, PROGETTO_PREV PROG, TIPO_PROGETTO, DIPARTIMENTO DIP,
...
Where       PAR.ESERCIZIO = CLA.ESERCIZIO And
            PAR.FL_NUOVO_PDG = 'N' And
            PREV_ENT.ID_CLASSIFICAZIONE = CLA.ID_CLASSIFICAZIONE And
...
Select PREV_ENT.ESERCIZIO,
       ...
       PREV_ENT.TOT_ENT_IST_A3,
       PREV_ENT.TOT_ENT_AREE_A3
From PARAMETRI_CNR PAR, V_CLASSIFICAZIONE_VOCI CLA, CDR, PROGETTO_PREV PROG, PROGETTO_PREV AREA_PROG, TIPO_PROGETTO, DIPARTIMENTO DIP,
    (Select PDG.ESERCIZIO, PDG.CD_CENTRO_RESPONSABILITA, PDG.PG_PROGETTO, PDG.ID_CLASSIFICAZIONE,
            PDG.CD_TERZO CD_TERZO_FINANZIATORE,
            DS_DETTAGLIO,
            IM_ENTRATA_TOT     TOT_FINANZIAMENTO,
...
Where       PAR.ESERCIZIO = CLA.ESERCIZIO And
            ...
            PREV_ENT.ID_CLASSIFICAZIONE = CLA.ID_CLASSIFICAZIONE And
            PREV_ENT.CD_CENTRO_RESPONSABILITA = CDR.CD_CENTRO_RESPONSABILITA AND
            PREV_ENT.PG_PROGETTO = PROG.PG_PROGETTO And
            PROG.ESERCIZIO = PREV_ENT.ESERCIZIO And
