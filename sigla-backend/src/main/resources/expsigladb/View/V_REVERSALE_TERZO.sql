...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_REVERSALE_TERZO" ("CD_CDS", "ESERCIZIO", "PG_REVERSALE", "CD_UNITA_ORGANIZZATIVA", "CD_CDS_ORIGINE", "CD_UO_ORIGINE", "CD_TIPO_DOCUMENTO_CONT", "TI_REVERSALE", "TI_COMPETENZA_RESIDUO", "DS_REVERSALE", "STATO", "DT_EMISSIONE", "DT_TRASMISSIONE", "DT_INCASSO", "DT_ANNULLAMENTO", "IM_REVERSALE", "IM_INCASSATO", "UTCR", "DACR", "UTUV", "DUVA", "PG_VER_REC", "STATO_TRASMISSIONE", "STATO_COGE", "DT_RITRASMISSIONE", "CD_TERZO", "CD_ANAG", "DENOMINAZIONE_SEDE", "FL_ASSOCIAZIONE_SIOPE_COMPLETA", "DT_FIRMA", "STATO_TRASMISSIONE_ANNULLO", "FL_RIEMISSIONE", "DT_FIRMA_ANNULLO", "PG_REVERSALE_RIEMISSIONE") AS 
  SELECT
--
--
-- Date: 21/06/2007
