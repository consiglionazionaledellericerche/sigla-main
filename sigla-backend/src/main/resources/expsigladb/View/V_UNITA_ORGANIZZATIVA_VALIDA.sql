...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "V_UNITA_ORGANIZZATIVA_VALIDA" ("ESERCIZIO", "ESERCIZIO_INIZIO", "CD_UNITA_ORGANIZZATIVA", "CD_PROPRIO_UNITA", "CD_TIPO_UNITA", "FL_CDS", "FL_UO_CDS", "FL_RUBRICA", "CD_UNITA_PADRE", "LIVELLO", "DS_UNITA_ORGANIZZATIVA", "PRC_COPERTURA_OBBLIG_2", "PRC_COPERTURA_OBBLIG_3", "CD_AREA_RICERCA", "FL_PRESIDENTE_AREA", "CD_RESPONSABILE", "CD_RESPONSABILE_AMM", "ESERCIZIO_FINE", "CD_AREA_SCIENTIFICA", "ID_FUNZIONE_PUBBLICA", "DACR", "UTCR", "DUVA", "UTUV", "PG_VER_REC") AS 
  SELECT
--
-- Date: 25/03/2010
-- Version: 1.5
