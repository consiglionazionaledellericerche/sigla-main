...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE VIEW "PRT_PAGA_ESTERO_CNR" ("ESERCIZIO", "COD_CDS", "LETTERA_NUM", "LETTERA_DATA", "UO_EMITTENTE", "DOC_TIPO", "DOC_NUM", "TERZO_COD", "TERZO_DES", "IMP_1210", "IMP_SOSP", "IMP_MAND") AS 
  select
--
-- Date: 03/04/2003
-- Version: 1.2
