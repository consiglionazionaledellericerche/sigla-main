CREATE OR REPLACE TRIGGER AD_L_BANCA AFTER  DELETE  ON BANCA for each row
DECLARE
...
begin
--
-- Trigger attivato su  DELETE  di record da BANCA
--
-- Date: 19/03/2004
-- Version: 1.0
--
...
-- Body:
  ...
  CLBANCA.updateRegistry(lTbName,'D',lUser);
END;
/
