CREATE OR REPLACE TRIGGER aiu_obbligazione_scad_voce
AFTER INSERT OR UPDATE OF ESERCIZIO, TI_APPARTENENZA, TI_GESTIONE, CD_VOCE
 ON OBBLIGAZIONE_SCAD_VOCE REFERENCING NEW AS NEW OLD AS OLD
FOR EACH ROW
declare
 recParametriCNR parametri_cnr%rowtype;
begin
--
-- Trigger attivato su inserimento  e aggiornamento voce nella tabella OBBLIGAZIONE_SCAD_VOCE (After)
--
-- Date: 08/09/2015
-- Version: 1.0
--
