CREATE OR REPLACE TRIGGER AD_L_ASS_COMP_DOC_CONT_NMP AFTER  DELETE  ON ASS_COMP_DOC_CONT_NMP for each row
DECLARE
...
begin
--
-- Trigger attivato su  DELETE  di record da ASS_COMP_DOC_CONT_NMP
--
-- Date: 08/04/2004
-- Version: 1.0
--
...
-- Body:
  ...
  lASS_COMP_DOC_CONT_NMP.ACTION_ := 'D';
  CLASS_COMP_DOC_CONT_NMP.insertRiga(lTbName,lASS_COMP_DOC_CONT_NMP);
  CLASS_COMP_DOC_CONT_NMP.updateRegistry(lTbName,'D',lUser);
END;
/
