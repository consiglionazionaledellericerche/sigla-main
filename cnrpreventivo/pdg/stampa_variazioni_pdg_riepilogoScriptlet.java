...
public class stampa_variazioni_pdg_riepilogoScriptlet extends it.businesslogic.ireport.IReportScriptlet {
...
public void beforeReportInit() throws JRScriptletException
{
	...
	try{
		...
		cs = conn.prepareCall("{call S_PDG_VARIAZIONE_DET(?,?,?,?,?)}");
		...
		cs.setObject(5,(java.lang.String)getParameterValue("Pg"));
		cs.executeQuery();
	}catch (Throwable e) {
