...
<title>Tabella codici IVA fatture acquisti</title>
</head>
<body class="Form">

<% CodiciIvaFattureAcquistiBP bp = (CodiciIvaFattureAcquistiBP)BusinessProcess.getBusinessProcess(request);
			...
			<tr>
				<td>
					<div class="Group" style="width:100%">
						...
						<% bp.getElenco().writeHTMLTable(pageContext,"elenco_cod_fat_acq",false,false,false,"100%","200px"); %>
					</div>
				</td>
			</tr>			
			<tr>
