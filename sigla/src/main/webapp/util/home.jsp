...
//--> end hide JavaScript
	...
	<%	try {
		...
		<frame id="desktop" name="desktop" scrolling="NO" noresize src="utenze00/desktop.jsp" class="frameColBorder">
	<%	} catch(it.cnr.jada.action.NoSuchBusinessProcessException e) { %>
			<frame name="desktop" scrolling="NO" noresize src="utenze00/form_login.jsp" class="frameColBorder">
	<%	} %>

	<%	String messagecheck_url = it.cnr.jada.util.Config.getHandler().getProperty("Message_check.url");
		if (messagecheck_url != null) { %>
		<frameset id="footer" cols="20,*" framespacing="0" frameborder="0">
			<frame name="mailbar" noresize src="<%= messagecheck_url%>" scrolling="NO" marginwidth="0" marginheight="0">
	<% 	} %>
