...
<title>Associazione Cap. Spesa CNR - Natura - Cap. Entrata CDS</title>
<body class="Form">
...
<% CRUDBP bp = (CRUDBP)BusinessProcess.getBusinessProcess(request);
	...
	<tr>
		...
		<td>
		    <% bp.getController().writeFormInput( out, "cd_tipo_unita"); %>
	    	<% bp.getController().writeFormInput( out, "ds_tipo_unita"); %>
	      <% bp.getController().writeFormInputByStatus( out, "find_tipo_unita"); %>	
		</td>				 
	</tr>
	<tr>
		<td><% bp.getController().writeFormLabel( out, "cd_natura"); %></td>
		<td><% bp.getController().writeFormInputByStatus( out, "cd_natura"); %></td>
	</tr>
	<tr>
