...
<title>Classificazione Entrate</title>
</head>
...
%>
	...
	<table class="Panel">
		...
		<TR><TD>
			<% bp.getController().writeFormLabel(out,"codice_cla_e");%>
			</TD><TD>
			<% bp.getController().writeFormInput(out,"codice_cla_e");%>
		</TD></TR>
		<TR><TD>
		...
		<TR><TD>
			<% bp.getController().writeFormLabel(out,"codice_cla_e_padre");%>
			</TD><TD colspan="3">
			<% bp.getController().writeFormInput(out,"esercizio_padre");%>
			<% bp.getController().writeFormInput(out,"codice_cla_e_padre");%>
			<% bp.getController().writeFormInput(out,"find_classificazione_entrate");%>
		</TD></TR>	
		<TR><TD>
