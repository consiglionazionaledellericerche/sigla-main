sigla:
  ...
  command: java -Xmx1g -Xss512k -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8787 -Duser.language=it -Dspring.perla.incarichi.url=https://adp-api.perlapa.gov.it/api -Dspring.perla.lg104url=https://legge104-api.perlapa.gov.it/api -Dspring.profiles.active=liquibase-cnr,pagopa -Dremote.maven.repo=https://repository.jboss.org/nexus/content/groups/public/,https://maven.repository.redhat.com/earlyaccess/all -DarubaRemoteSignService.typeOtpAuth=demoprod -DarubaRemoteSignService.url=https://arss.demo.firma-automatica.it/ArubaSignService/ArubaSignService?wsdl -Djava.security.egd=file:/dev/./urandom -jar /opt/sigla-thorntail.jar -s/opt/project-formazione.yml
  extra_hosts:
