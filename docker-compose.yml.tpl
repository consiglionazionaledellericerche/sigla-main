sigla:
  ...
  command: java -Xmx1g -Xss512k -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8787 -Duser.country=IT -Duser.language=it -Dfile.encoding=UTF8  -Dspring.profiles.active=liquibase-cnr,pagopa -Dremote.maven.repo=https://repository.jboss.org/nexus/content/groups/public/,https://maven.repository.redhat.com/earlyaccess/all -DarubaRemoteSignService.url=http://arss3.cedrc.cnr.it:8080/ArubaSignService/ArubaSignService?WSDL -Djava.security.egd=file:/dev/./urandom -jar /opt/sigla-thorntail.jar -s/opt/project-formazione.yml
  extra_hosts:
    - "sigla-print-siglat.test.si.cnr.it:150.146.206.186"
