...
public  CodiciCpaComponentWS() {
}

public java.util.ArrayList<CodiciCpa> cercaCodiciCpa(
		  String query,
		  Integer esercizio,
		  String dominio,
		  Integer numMax,
...
try {
	...
	if(query== null){
		...
		try {
			lista=(((FatturaAttivaSingolaComponentSession)it.cnr.jada.util.ejb.EJBCommonServices.createEJB("CNRDOCAMM00_EJB_FatturaAttivaSingolaComponentSession",FatturaAttivaSingolaComponentSession.class)).findListaCodiciCpaWS(userContext,query, dominio, ricerca));
