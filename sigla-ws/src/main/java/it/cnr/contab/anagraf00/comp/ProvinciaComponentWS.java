...
public  ProvinciaComponentWS() {
}

public java.util.ArrayList<Provincia> cercaProvincia(
		  String query,
		  String dominio,
		  Integer numMax,
		  String user,
...
try {
	...
	if(query== null){
		...
		try {
			lista=(((FatturaAttivaSingolaComponentSession)it.cnr.jada.util.ejb.EJBCommonServices.createEJB("CNRDOCAMM00_EJB_FatturaAttivaSingolaComponentSession",FatturaAttivaSingolaComponentSession.class)).findListaProvinciaWS(userContext,query,dominio, ricerca));
