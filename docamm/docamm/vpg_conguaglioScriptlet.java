...
public class vpg_conguaglioScriptlet extends it.businesslogic.ireport.IReportScriptlet {
...
public void beforeReportInit() throws JRScriptletException
{
	...
	try{
		...
		cs = conn.prepareCall("{call SPG_CONGUAGLIO(?,?,?,?)}");
		...
		cs.setObject(4,(java.lang.Integer)getParameterValue("Pg_conguaglio"));
		cs.executeQuery();
	}catch (Throwable e) {
