...
public class Rendiconto_finanziario_decisionale_Parte_EntrateScriptlet extends it.businesslogic.ireport.IReportScriptlet {
...
public void beforeReportInit() throws JRScriptletException
{
	...
	try{
		...
		cs.setObject(2,"E");
		cs.setObject(3,((java.lang.Boolean)getParameterValue("ufficiale")?"Y":"N"));
		cs.executeQuery();
	}catch (Throwable e) {
