...
<title>Tabella riepilogativa quadri VA - VF</title>
</head>
<body class="Form">

<% QuadriVaVfBP bp = (QuadriVaVfBP)BusinessProcess.getBusinessProcess(request);
			...
			<tr>
				<td>
					<div class="Group" style="width:100%">
						...
						<% bp.getElenco().writeHTMLTable(pageContext,"elenco_va_vf",false,false,false,"100%","200px"); %>
					</div>
				</td>
			</tr>			
			<tr>
			...
			<tr>
				<td>
					<div class="Group" style="width:100%">
						...
						<% bp.getElencoSecondario().writeHTMLTable(pageContext,"elenco_sec_va_vf",false,false,false,"100%","200px"); %>
					</div>
				</td>
			</tr>			
			<tr>
