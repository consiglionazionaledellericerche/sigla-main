<%@ page import = "it.cnr.jada.util.jsp.*,it.cnr.jada.action.*,java.util.*, it.cnr.jada.util.action.*, it.cnr.contab.missioni00.bp.*, it.cnr.contab.missioni00.docs.bulk.*, it.cnr.jada.bulk.*, it.cnr.contab.anagraf00.tabrif.bulk.*,it.cnr.contab.docamm00.bp.IDocumentoAmministrativoSpesaBP"%>
...
<table width="100%">
	...
	<td><% bp.getController().writeFormLabel( out, "dt_fine_missione"); %></td>
	<td><% bp.getController().writeFormInput( out, "dt_fine_missione");%></td>
	</tr>

	<tr>
	<td><% bp.getController().writeFormLabel( out, "ds_missione"); %></td>
	<td><% bp.getController().writeFormInput( out, "ds_missione"); %></td>
	<td colspan="2"></td>
	</tr>
	...
	<td colspan="2"><% bp.getController().writeFormInput( out, null, "ti_istituz_commerc", false, null, "onClick=\"submitForm('doOnIstituzionaleCommercialeChange')\"");%></td>	
	</tr>
