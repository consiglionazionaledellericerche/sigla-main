<%@ page import = "it.cnr.jada.util.jsp.*,it.cnr.jada.action.*,java.util.*, it.cnr.jada.util.action.*, it.cnr.contab.missioni00.bp.*, it.cnr.contab.missioni00.docs.bulk.*, it.cnr.jada.bulk.*, it.cnr.contab.anagraf00.tabrif.bulk.*"%>
...
<table width="100%">
	...
	<td>
		...
		<% bp.getController().writeFormInput( out, null,"tipo_rapporto",false,null,"onChange=\"submitForm('doOnTipoRapportoChange')\"");%>
		<% bp.getController().writeFormLabel( out, "rif_inquadramento"); %>
		<% bp.getController().writeFormInput( out, null,"rif_inquadramento",false,null,"onChange=\"submitForm('doOnInquadramentoChange')\"");%>
	</td>
	</tr>
</table>
</div>