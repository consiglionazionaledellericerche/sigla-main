...
<%
    ...
    if ( riga!=null && riga.getTuttiMagazzini()!=null && riga.getTuttiMagazzini() ){
        pages = new String[][] {
    	      			{ "tabAbilOrdiniDettaglio","Dettaglio Abilitazione Ordine","/utenze00/tab_abil_ordine_dettaglio.jsp" }};
	}else{
        pages = new String[][] {
	      			{ "tabAbilOrdiniDettaglio","Dettaglio Abilitazione Ordine","/utenze00/tab_abil_ordine_dettaglio.jsp" },
					{ "tabAbilOrdiniMagazzini","Magazzini","/utenze00/tab_abil_ordine_magazzini.jsp" } };
	}
	JSPUtils.tabbed(pageContext, "tabAbilOrdineUtenze",
		pages,
		bp.getTab("tabAbilOrdineUtenze"), "left", "100%", null, true);
%>			
</div>
