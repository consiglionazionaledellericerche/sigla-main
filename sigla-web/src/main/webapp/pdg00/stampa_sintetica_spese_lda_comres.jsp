<%@ page pageEncoding="UTF-8"
	import="it.cnr.jada.util.jsp.*,
			...
			it.cnr.contab.pdg00.bulk.Stampa_sintetica_spese_ldaBulk"
%>
...
<title>Stampa Sintetica Spese Competenza\Residuo</title>
</head>
<body class="Form">

<%	BulkBP bp = (BulkBP)BusinessProcess.getBusinessProcess(request);
	bp.openFormWindow(pageContext); 
	Stampa_sintetica_spese_ldaBulk bulk=(Stampa_sintetica_spese_ldaBulk)bp.getModel(); %>
