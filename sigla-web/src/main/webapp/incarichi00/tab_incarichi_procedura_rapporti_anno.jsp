...
function doScaricaFile() {	
   ...
   window.open("<%= (rapporto==null?null:rapporto.getDownloadUrl().replace("'", "_")) %>","DOWNLOAD","left="+sinistra+",top="+alto+",width="+larghFinestra+", height="+altezFinestra+",menubar=no,toolbar=no,location=no")
}
</script>
