  	...
  	<table>
		<tr>
			<% if (!bp.isSearching()) { %>
		     	...
		     	<td colspan="5">
		      		<% bp.getController().writeFormInput(out,null,"ti_istituz_commerc",roOnAutoGen,null,"onChange=\"submitForm('doOnIstituzionaleCommercialeChange')\"");%>
		      	</td>
			<% } else { %>
		     	<td>
		     	...
		     	<td colspan="5">
		      		<% bp.getController().writeFormInput(out,null,"ti_istituz_commercSearch",roOnAutoGen,null,"onChange=\"submitForm('doOnIstituzionaleCommercialeChange')\"");%>
		      	</td>
			<% } %>
      </tr>
