...
<%	CRUDEsenzioni_addizionaliBP bp = (CRUDEsenzioni_addizionaliBP)BusinessProcess.getBusinessProcess(request);
	...
	<table style="width:100%">
       <tr>
		...
		<td>
			<% JSPUtils.button(out,null,null,"Carica Aggiornamenti","javascript:submitForm('doCarica')", 
