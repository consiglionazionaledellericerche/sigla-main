...
<%  it.cnr.contab.doccont00.bp.CRUDSospesoCNRBP bp = (it.cnr.contab.doccont00.bp.CRUDSospesoCNRBP)BusinessProcess.getBusinessProcess(request);
	...
	<tr>
		<tr><td><% bp.getSospesiFigli().writeFormLabel( out, "cd_cds_origine"); %></td>
	       <td><% bp.getSospesiFigli().writeFormInput( out, "cd_cds_origine"); %>
	            <% bp.getSospesiFigli().writeFormInput( out, "ds_cds_origine"); %>
	             <% bp.getSospesiFigli().writeFormInput( out, "find_cds_origine"); %>	    
		</td>
