...
public class MetadataEncodingUtilsTest {
    ...
    public void decodeValues() throws Exception {
        ...
        assertEquals("Stig Tøfting", s.get(0));
        assertEquals("Jesper Grønkjær", s.get(1));
    }

    @Test
    public void encodeKey() throws Exception {
        String encodedKey = MetadataEncodingUtils.encodeKey("foo_pippo:bar-baz");
        assertEquals("CNR_Zm9vX3BpcHBvOmJhci1iYXo", encodedKey);
    }
