...
public final class ASCIIFoldingFilter  {
  ...
  public static String foldToASCII(String inputString) {
    char [] input = new char[inputString.length()];
    ASCIIFoldingFilter.foldToASCII(inputString.toCharArray(), 0, input, 0, inputString.length());
   ...
   * @lucene.internal
   */
  private static final int foldToASCII(char input[], int inputPos, char output[], int outputPos, int length)
  {
