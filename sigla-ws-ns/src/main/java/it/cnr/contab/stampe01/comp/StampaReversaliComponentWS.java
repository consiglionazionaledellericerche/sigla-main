...
public byte[] DownloadReversale(String user, String cds,String esercizio,String pgReversale) throws NumberFormatException, PersistencyException, ComponentException, RemoteException, EJBException, Exception {
	try{
   ...
   return ((ReversaleComponentSession)it.cnr.jada.util.ejb.EJBCommonServices.createEJB("CNRDOCCONT00_EJB_ReversaleComponentSession",ReversaleComponentSession.class)).
			lanciaStampa(userContext, cds, new Integer(esercizio),new Long(pgReversale));
