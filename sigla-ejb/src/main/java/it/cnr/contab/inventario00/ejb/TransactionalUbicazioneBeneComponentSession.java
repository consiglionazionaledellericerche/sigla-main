...
public class TransactionalUbicazioneBeneComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements UbicazioneBeneComponentSession {
