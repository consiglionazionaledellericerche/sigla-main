...
public class TransactionalFondoSpesaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements FondoSpesaComponentSession {
...
public it.cnr.contab.fondecon00.core.bulk.Fondo_spesaBulk setCitta(it.cnr.jada.UserContext param0,it.cnr.contab.fondecon00.core.bulk.Fondo_spesaBulk param1,it.cnr.contab.anagraf00.tabter.bulk.ComuneBulk param2) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.fondecon00.core.bulk.Fondo_spesaBulk)invoke("setCitta",new Object[] {
			param0,
			param1,
			param2 });
	} catch(java.rmi.RemoteException e) {
