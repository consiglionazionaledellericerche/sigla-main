...
public class Geco_dipartimentoBase extends Geco_dipartimentoKey implements Keyed {
...
//    ordine DECIMAL(10,0) NOT NULL
	...
	public Geco_dipartimentoBase() {
		super();
	}
	public Geco_dipartimentoBase(java.lang.String cod_dip) {
		super(cod_dip);
	}
