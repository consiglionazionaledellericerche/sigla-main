...
public interface Parametri_cnrComponentSession extends it.cnr.jada.ejb.CRUDComponentSession{
	...
	public boolean isLivelloPdgContrattazioneSpeEnabled(it.cnr.jada.UserContext param0, it.cnr.contab.config00.bulk.Parametri_cnrBulk param1) throws it.cnr.jada.comp.ComponentException,java.rmi.RemoteException;
