...
public class Configurazione_cnrHome extends BulkHome {
    ...
    public List findTipoVariazioniPdg() throws PersistencyException {
    ...
    public List findTipoVariazioniStanz_res() throws PersistencyException {
    ...
    public List findTipoVariazioniEnteStanz_res() throws PersistencyException {
    ...
    public Configurazione_cnrBulk getConfigurazioneCnrBulk(Integer esercizio, String unita_funzionale, String chiave_primaria, String chiave_secondaria) throws PersistencyException {
        ...
        return (Configurazione_cnrBulk) getHomeCache().getHome(Configurazione_cnrBulk.class).findByPrimaryKey(new Configurazione_cnrKey(chiave_primaria, chiave_secondaria, unita_funzionale, esercizio));
    }
