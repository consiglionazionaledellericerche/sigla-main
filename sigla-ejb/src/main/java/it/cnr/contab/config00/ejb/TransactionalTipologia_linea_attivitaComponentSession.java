...
public class TransactionalTipologia_linea_attivitaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements Tipologia_linea_attivitaComponentSession {
public void annullaModificaCdrAssociati(it.cnr.jada.UserContext param0,it.cnr.contab.config00.latt.bulk.Tipo_linea_attivitaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		invoke("annullaModificaCdrAssociati",new Object[] {
			param0,
			param1 });
...
public void associaTuttiCdr(it.cnr.jada.UserContext param0,it.cnr.contab.config00.latt.bulk.Tipo_linea_attivitaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		invoke("associaTuttiCdr",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.jada.util.RemoteIterator cercaCdrAssociabili(it.cnr.jada.UserContext param0,it.cnr.contab.config00.latt.bulk.Tipo_linea_attivitaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.jada.util.RemoteIterator)invoke("cercaCdrAssociabili",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public void inizializzaCdrAssociatiPerModifica(it.cnr.jada.UserContext param0,it.cnr.contab.config00.latt.bulk.Tipo_linea_attivitaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		invoke("inizializzaCdrAssociatiPerModifica",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public void modificaCdrAssociati(it.cnr.jada.UserContext param0,it.cnr.contab.config00.latt.bulk.Tipo_linea_attivitaBulk param1,it.cnr.jada.bulk.OggettoBulk[] param2,java.util.BitSet param3,java.util.BitSet param4) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		invoke("modificaCdrAssociati",new Object[] {
			param0,
			param1,
			param2,
			param3,
