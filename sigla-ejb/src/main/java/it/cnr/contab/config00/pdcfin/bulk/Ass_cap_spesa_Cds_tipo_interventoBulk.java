 ...
 * In particolare, si tratta di un'associazione tra capitolo di spesa del Cds e tipologia
 * di intervento.
 */
public class Ass_cap_spesa_Cds_tipo_interventoBulk extends Ass_ev_evBulk {

public Ass_cap_spesa_Cds_tipo_interventoBulk() {
	super();
	...
	setTi_appartenenza_coll(Elemento_voceHome.APPARTENENZA_CNR);
	setTi_gestione_coll(Elemento_voceHome.GESTIONE_SPESE);
	// elemento_voce_coll.setTi_appartenenza(Elemento_voceHome.APPARTENENZA_CNR);
...
public Ass_cap_spesa_Cds_tipo_interventoBulk(java.lang.String cd_cds,java.lang.String cd_elemento_voce,java.lang.String cd_elemento_voce_coll,java.lang.String cd_natura,java.lang.Integer esercizio,java.lang.String ti_appartenenza,java.lang.String ti_appartenenza_coll,java.lang.String ti_gestione,java.lang.String ti_gestione_coll) {
...
public void validate() throws ValidationException 
{
	...
	if ( elemento_voce_coll == null || elemento_voce_coll.getCd_elemento_voce() == null || elemento_voce_coll.getCd_elemento_voce().equals(""))
		throw new ValidationException( "Il campo TIPOLOGIA di INTERVENTO è obbligatorio." );
}
}
