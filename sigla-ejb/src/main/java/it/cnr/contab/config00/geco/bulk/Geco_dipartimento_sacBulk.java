...
public class Geco_dipartimento_sacBulk extends Geco_dipartimento_sacBase implements Geco_dipartimentoIBulk{
	public Geco_dipartimento_sacBulk() {
		super();
	}
	public Geco_dipartimento_sacBulk(java.lang.String cod_dip) {
		super(cod_dip);
	}
