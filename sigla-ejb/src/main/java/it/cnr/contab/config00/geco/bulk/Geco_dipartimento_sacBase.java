...
public class Geco_dipartimento_sacBase extends Geco_dipartimento_sacKey implements Keyed {
...
//    ordine DECIMAL(10,0) NOT NULL
	...
	public Geco_dipartimento_sacBase() {
		super();
	}
	public Geco_dipartimento_sacBase(java.lang.String cod_dip) {
		super(cod_dip);
	}
