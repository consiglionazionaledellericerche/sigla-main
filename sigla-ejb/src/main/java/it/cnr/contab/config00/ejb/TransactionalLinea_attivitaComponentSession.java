...
public void Inserimento_BLOB(UserContext param0,it.cnr.jada.bulk.OggettoBulk param1,java.io.File param2) throws it.cnr.jada.comp.ComponentException,javax.ejb.EJBException, PersistencyException, RemoteException  {
	try {
		invoke("Inserimento_BLOB",new Object[] {
				param0,
				param1,
				param2});
	} catch(java.rmi.RemoteException e) {
