...
public class DottoratiHome extends BulkHome {
	private static final long serialVersionUID = 1L;

	public DottoratiHome(java.sql.Connection conn) {
		super(DottoratiBulk.class,conn);
	}
	public DottoratiHome(java.sql.Connection conn, PersistentCache persistentCache) {
		super(DottoratiBulk.class,conn,persistentCache);
	}
	...
	public void initializePrimaryKeyForInsert(UserContext  usercontext,OggettoBulk oggettobulk)throws PersistencyException, ComponentException {
		try {
			DottoratiBulk atto = (DottoratiBulk)oggettobulk;
			atto.setId(
