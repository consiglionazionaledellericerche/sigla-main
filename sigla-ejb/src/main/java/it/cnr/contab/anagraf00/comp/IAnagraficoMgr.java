...
public interface IAnagraficoMgr extends ICRUDMgr
{
 ...
 */
//^^@@
public abstract AnagraficoBulk setComune_fiscale (UserContext userContext,AnagraficoBulk anagrafico,ComuneBulk comune) throws ComponentException;

String calcolaCodiceFiscale(UserContext userContext, AnagraficoBulk anagBulk) throws it.cnr.jada.comp.ComponentException;

AnagraficoBulk getAnagraficoEnte(UserContext userContext) throws it.cnr.jada.comp.ComponentException;

TerzoBulk getDefaultTerzo(UserContext userContext,AnagraficoBulk anagrafico) throws ComponentException;
}