...
public class TerzoBulk extends TerzoBase {
	...
	private List rif_modalita_pagamento             = new it.cnr.jada.util.Collect(modalita_pagamento,"rif_modalita_pagamento");
	...
	private List rif_termini_pagamento              = new it.cnr.jada.util.Collect(termini_pagamento,"rif_termini_pagamento");
 ...
 * @return it.cnr.jada.bulk.BulkList
 */
public it.cnr.jada.bulk.BulkList getModalita_pagamento() {
