...
/**
  * Costruisce l'struzione SQL corrispondente ad una ricerca con le clausole specificate.
  * Aggiunge una clausola a tutte le operazioni di ricerca eseguite sul Terzo per la stampa.
  *
  * Nome: Richiesta di ricerca di un Terzo per la Stampa Previdenziale Dipendenti
  * Pre: E' stata generata la richiesta di ricerca dei Terzi validi per la Stampa Previdenziale Dipendenti.
  * Post: Viene restituito l'SQLBuilder per filtrare i Terzi
  *
  * @param userContext	lo userContext che ha generato la richiesta
  * @param stampa		l'OggettoBulk che rappresenta il contesto della ricerca.
...
/*public SQLBuilder selectTerzoForPrintByClause(UserContext userContext, Stampa_previdenziale_dipendentiVBulk stampa, TerzoBulk terzo, CompoundFindClause clauses) throws ComponentException {
