...
public class IpaServizioFatturaKey extends OggettoBulk implements KeyedPersistent {
	 ...
	 **/
	public IpaServizioFatturaKey() {
		super();
	}
	public IpaServizioFatturaKey(java.lang.String codAmm, java.lang.String codOu) {
		super();
		this.codAmm=codAmm;
		this.codOu=codOu;
	}
	public boolean equalsByPrimaryKey(Object o) {
		...
		if (!(o instanceof IpaServizioFatturaKey)) return false;
		IpaServizioFatturaKey k = (IpaServizioFatturaKey) o;
