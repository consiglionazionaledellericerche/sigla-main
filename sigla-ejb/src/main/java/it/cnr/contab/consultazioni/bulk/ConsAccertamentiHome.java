...
public class ConsAccertamentiHome extends BulkHome {
	public ConsAccertamentiHome(java.sql.Connection conn) {
		super(ConsAccertamentiBulk.class, conn);
	}
	public ConsAccertamentiHome(java.sql.Connection conn, PersistentCache persistentCache) {
		super(ConsAccertamentiBulk.class, conn, persistentCache);
	}
	public ConsAccertamentiHome(Class clazz,java.sql.Connection conn) {
		super(clazz,conn);
	}
	public ConsAccertamentiHome(Class clazz,java.sql.Connection conn,PersistentCache persistentCache) {
