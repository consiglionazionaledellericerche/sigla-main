...
public class TransactionalTipoTrattamentoComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements TipoTrattamentoComponentSession {
public java.util.List caricaIntervalli(it.cnr.jada.UserContext param0,it.cnr.contab.compensi00.tabrif.bulk.Tipo_trattamentoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
...
public boolean isUltimoIntervallo(it.cnr.jada.UserContext param0,it.cnr.contab.compensi00.tabrif.bulk.Tipo_trattamentoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
