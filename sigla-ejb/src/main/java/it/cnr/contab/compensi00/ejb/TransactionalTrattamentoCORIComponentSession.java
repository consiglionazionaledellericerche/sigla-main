...
public class TransactionalTrattamentoCORIComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements TrattamentoCORIComponentSession {
...
public it.cnr.contab.compensi00.tabrif.bulk.Trattamento_coriBulk fillAllRows(it.cnr.jada.UserContext param0,it.cnr.contab.compensi00.tabrif.bulk.Trattamento_coriBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.compensi00.tabrif.bulk.Trattamento_coriBulk)invoke("fillAllRows",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
