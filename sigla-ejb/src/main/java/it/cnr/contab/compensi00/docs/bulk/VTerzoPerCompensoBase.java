...
public class VTerzoPerCompensoBase extends VTerzoPerCompensoKey implements Persistent {
...
public VTerzoPerCompensoBase() {
	super();
}
public VTerzoPerCompensoBase(java.sql.Timestamp dt_ini_validita,java.lang.Integer cd_terzo, String ti_dipendente_altro) {
