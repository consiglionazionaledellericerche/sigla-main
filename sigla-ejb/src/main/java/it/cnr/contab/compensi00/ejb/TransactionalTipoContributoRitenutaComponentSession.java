...
public class TransactionalTipoContributoRitenutaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements TipoContributoRitenutaComponentSession {
public java.util.List caricaIntervalli(it.cnr.jada.UserContext param0,it.cnr.contab.compensi00.tabrif.bulk.Tipo_contributo_ritenutaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
...
public boolean isUltimoIntervallo(it.cnr.jada.UserContext param0,it.cnr.contab.compensi00.tabrif.bulk.Tipo_contributo_ritenutaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
...
public java.util.Collection loadClassificazioneCori(it.cnr.jada.UserContext param0) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.util.Collection)invoke("loadClassificazioneCori",new Object[] {
			param0 });
	} catch(java.rmi.RemoteException e) {
		throw e;
	} catch(java.lang.reflect.InvocationTargetException e) {
...
public java.util.Collection loadClassificazioneMontanti(it.cnr.jada.UserContext param0) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.util.Collection)invoke("loadClassificazioneMontanti",new Object[] {
			param0 });
	} catch(java.rmi.RemoteException e) {
		throw e;
	} catch(java.lang.reflect.InvocationTargetException e) {
