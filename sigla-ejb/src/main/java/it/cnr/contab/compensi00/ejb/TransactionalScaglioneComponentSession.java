...
public class TransactionalScaglioneComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements ScaglioneComponentSession {
...
public boolean isUltimoIntervallo(it.cnr.jada.UserContext param0,it.cnr.contab.compensi00.tabrif.bulk.ScaglioneBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
...
public void validaScaglione(it.cnr.jada.UserContext param0,it.cnr.jada.bulk.OggettoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		invoke("validaScaglione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
