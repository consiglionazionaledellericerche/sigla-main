...
public class CRUDIncarichiProceduraBP extends it.cnr.jada.util.action.SimpleCRUDBP {
    ...
    private final SimpleDetailCRUDController compensiAllegati = new SimpleDetailCRUDController("CompensiAllegati", CompensoBulk.class, "compensiColl", ripartizionePerAnno);
    private final SimpleDetailCRUDController compensiAllegatiIncarico = new SimpleDetailCRUDController("CompensiAllegatiIncarico", CompensoBulk.class, "compensiColl", ripartizioneIncarichiPerAnno);
    ...
    private final SimpleDetailCRUDController incarichiColl = new SimpleDetailCRUDController("IncarichiColl", Incarichi_repertorioBulk.class, "incarichi_repertorioColl", this) {
    ...
    private SimpleDetailCRUDController incarichiRappColl = new Incarichi_archivioCRUDController("IncarichiRapp", Incarichi_repertorio_rappBulk.class, "incarichi_repertorio_rappColl", incarichiColl) {
        ...
        public boolean isGrowable() {
            Incarichi_repertorioBulk incarico = (Incarichi_repertorioBulk) getParentController().getModel();
    ...
    public void salvaDefinitivo(it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
        try {
            ...
            if (procedura.getIncarichi_repertorioValidiColl().size() == 1)
                Utility.createIncarichiRepertorioComponentSession().salvaDefinitivo(context.getUserContext(), procedura.getIncarichi_repertorioValidiColl().get(0));
...
//			((IncarichiProceduraComponentSession)createComponentSession()).archiviaAllegati(context.getUserContext(), (Incarichi_proceduraBulk)getModel());
    ...
    public void salvaDefinitivoContratto(it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
        try {
            ...
            Utility.createIncarichiRepertorioComponentSession().salvaDefinitivo(context.getUserContext(), incarico);
    ...
    public void annullaDefinitivo(it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
        try {
            ...
            if (procedura.getIncarichi_repertorioValidiColl().size() == 1)
                Utility.createIncarichiRepertorioComponentSession().annullaDefinitivo(context.getUserContext(), procedura.getIncarichi_repertorioValidiColl().get(0));
...
//			((IncarichiProceduraComponentSession)createComponentSession()).archiviaAllegati(context.getUserContext(), (Incarichi_proceduraBulk)getModel());
    ...
    public void annullaDefinitivoContratto(it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
        try {
            ...
            if (incarico != null)
                Utility.createIncarichiRepertorioComponentSession().annullaDefinitivo(context.getUserContext(), incarico);
