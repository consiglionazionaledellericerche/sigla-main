...
public enum CMISContrattiAspect {
	...
	private CMISContrattiAspect(String value) {
		this.value = value;
	}
	...
	public static CMISContrattiAspect fromValue(String v) {
		for (CMISContrattiAspect c : CMISContrattiAspect.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
