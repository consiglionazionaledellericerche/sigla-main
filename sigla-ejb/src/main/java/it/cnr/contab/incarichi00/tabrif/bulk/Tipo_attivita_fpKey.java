...
public class Tipo_attivita_fpKey extends OggettoBulk implements KeyedPersistent {
	private java.lang.String cd_tipo_attivita;
	public Tipo_attivita_fpKey() {
		super();
	}
	public Tipo_attivita_fpKey(java.lang.String cd_tipo_attivita) {
		super();
		this.cd_tipo_attivita=cd_tipo_attivita;
	}
	public boolean equalsByPrimaryKey(Object o) {
		if (this== o) return true;
		if (!(o instanceof Tipo_attivita_fpKey)) return false;
		Tipo_attivita_fpKey k = (Tipo_attivita_fpKey) o;
