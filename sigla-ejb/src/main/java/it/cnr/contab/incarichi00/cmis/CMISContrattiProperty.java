...
public enum CMISContrattiProperty {
	...
	private CMISContrattiProperty(String value) {
		this.value = value;
	}
	...
	public static CMISContrattiProperty fromValue(String v) {
		for (CMISContrattiProperty c : CMISContrattiProperty.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
