...
public class CRUDConfigTipoLimiteBP extends it.cnr.jada.util.action.SimpleCRUDBP {
	public CRUDConfigTipoLimiteBP() {
		super();
	}

	public CRUDConfigTipoLimiteBP(String function) {
		super(function);
	}
