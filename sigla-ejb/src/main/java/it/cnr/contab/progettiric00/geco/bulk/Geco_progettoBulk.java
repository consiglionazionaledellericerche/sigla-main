...
public class Geco_progettoBulk extends Geco_progettoBase implements Geco_progettoIBulk{
	public Geco_progettoBulk() {
		super();
	}
	public Geco_progettoBulk(java.lang.Long id_prog, java.lang.Long esercizio, java.lang.String fase) {
	...
	public void aggiornaProgettoSIP(Progetto_sipBulk progetto_sip){
		...
		if (getData_istituzione_prog() != null && !getData_istituzione_prog().equals(progetto_sip.getDt_inizio())){
