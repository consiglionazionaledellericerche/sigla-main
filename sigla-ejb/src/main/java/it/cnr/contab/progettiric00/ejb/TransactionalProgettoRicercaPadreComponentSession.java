...
public void validaPianoEconomico(it.cnr.jada.UserContext param0, it.cnr.contab.progettiric00.core.bulk.ProgettoBulk param1) throws ComponentException, RemoteException {
	try {
