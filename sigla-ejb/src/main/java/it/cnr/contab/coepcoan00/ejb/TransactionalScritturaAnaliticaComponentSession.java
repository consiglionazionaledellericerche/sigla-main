...
public class TransactionalScritturaAnaliticaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements ScritturaAnaliticaComponentSession {
