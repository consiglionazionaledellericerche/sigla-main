...
public class CRUDPdGAggregatoModuloBP extends it.cnr.jada.util.action.SimpleCRUDBP {
	...
	/**
	 * Stabilisce se l'utente � abilitato ad effettuare inserimenti 
	...
	/**
	 * Stabilisce se � utilizzabile il CdR preimpostato in mappa
	...
	public boolean isROModuloEntrate() {
		// se lo stato del CdR � in esame dal centro il 999.000 pu� entrare in
	...
	/**
	 * Stabilisce se si pu� operare (modificare) il gestionale
	 *  
