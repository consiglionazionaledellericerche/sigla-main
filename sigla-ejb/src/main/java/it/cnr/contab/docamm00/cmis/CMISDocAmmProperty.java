...
public enum CMISDocAmmProperty {
	...
	private CMISDocAmmProperty(String value) {
		this.value = value;
	}
	...
	public static CMISDocAmmProperty fromValue(String v) {
		for (CMISDocAmmProperty c : CMISDocAmmProperty.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
