...
public class TransactionalCambioComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements CambioComponentSession {
...
public boolean validaCambio(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.tabrif.bulk.CambioBulk param1) throws RemoteException {
	try {
		return ((Boolean)invoke("validaCambio",new Object[] {
			param0,
			param1 })).booleanValue();
	} catch(java.rmi.RemoteException e) {
		throw e;
