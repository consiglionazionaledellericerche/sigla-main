...
public class DocumentoEleAcquistoKey extends OggettoBulk implements KeyedPersistent {
	...
	private java.lang.Long progressivoAcquisto;
	
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Table name: DOCUMENTO_ELE_ACQUISTO
	 **/
	public DocumentoEleAcquistoKey() {
		super();
	}
	public DocumentoEleAcquistoKey(java.lang.String idPaese, java.lang.String idCodice, java.lang.Long identificativoSdi, java.lang.Long progressivo, java.lang.Long progressivoAcquisto){
		super();
		this.idPaese=idPaese;
		this.idCodice=idCodice;
		this.identificativoSdi=identificativoSdi;
		this.progressivo=progressivo;
		this.progressivoAcquisto=progressivoAcquisto;		
		
	}
	public boolean equalsByPrimaryKey(Object o) {
		if (this== o) return true;
		if (!(o instanceof DocumentoEleAcquistoKey)) return false;
		DocumentoEleAcquistoKey k = (DocumentoEleAcquistoKey) o;
		...
		if (!compareKey(getProgressivoAcquisto(), k.getProgressivoAcquisto())) return false;
	...
	public int primaryKeyHashCode() {
		...
		i = i + calculateKeyHashCode(getProgressivoAcquisto());
		return i;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	...
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Restituisce il valore di: [progressivoAcquisto]
	 **/
	public void setProgressivoAcquisto(java.lang.Long progressivoAcquisto)  {
		this.progressivoAcquisto=progressivoAcquisto;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Setta il valore di: [progressivoAcquisto]
	 **/
	public java.lang.Long getProgressivoAcquisto() {
		return progressivoAcquisto;
	}		
}