...
public class DocumentoEleTributiKey extends OggettoBulk implements KeyedPersistent {
	...
	private java.lang.Long progressivoTributo;
	
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Table name: DOCUMENTO_ELE_TRIBUTI
	 **/
	public DocumentoEleTributiKey() {
		super();
	}
	public DocumentoEleTributiKey(java.lang.String idPaese, java.lang.String idCodice, java.lang.Long identificativoSdi, java.lang.Long progressivo, java.lang.Long progressivoTributo) {
		super();
	...
	public boolean equalsByPrimaryKey(Object o) {
		...
		if (!(o instanceof DocumentoEleTributiKey)) return false;
		DocumentoEleTributiKey k = (DocumentoEleTributiKey) o;
		...
		if (!compareKey(getProgressivoTributo(), k.getProgressivoTributo())) return false;
	...
	public int primaryKeyHashCode() {
		...
		i = i + calculateKeyHashCode(getProgressivoTributo());
		return i;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 ...
	 **/
	public void setProgressivoTributo(java.lang.Long progressivoTributo)  {
		this.progressivoTributo=progressivoTributo;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Setta il valore di: [progressivoTributo]
	 **/
	public java.lang.Long getProgressivoTributo() {
