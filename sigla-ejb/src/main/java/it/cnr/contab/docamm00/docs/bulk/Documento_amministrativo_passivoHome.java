 ...
 */
protected Documento_amministrativo_passivoHome(Class clazz, java.sql.Connection connection) {
 ...
 */
protected Documento_amministrativo_passivoHome(Class clazz, java.sql.Connection connection, it.cnr.jada.persistency.PersistentCache persistentCache) {
