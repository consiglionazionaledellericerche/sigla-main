...
import it.cnr.contab.docamm00.docs.bulk.Fattura_attiva_rigaKey;
import it.cnr.jada.bulk.OggettoBulk;
import it.cnr.jada.persistency.KeyedPersistent;
public class VFatturaPassivaRigaBrevettiKey extends OggettoBulk implements KeyedPersistent {
...
public VFatturaPassivaRigaBrevettiKey() {
	super();
}

public VFatturaPassivaRigaBrevettiKey(java.lang.String cd_cds,java.lang.String cd_unita_organizzativa,java.lang.Integer esercizio,java.lang.Long pg_fattura_passiva,java.lang.Long progressivo_riga) {
	this.cd_cds = cd_cds;
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof VFatturaPassivaRigaBrevettiKey)) return false;
	VFatturaPassivaRigaBrevettiKey k = (VFatturaPassivaRigaBrevettiKey)o;
