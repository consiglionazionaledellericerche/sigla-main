 ...
 * @author: Roberto Peli
 */
public class Nota_di_creditoHome extends Fattura_passivaHome {
/**
 * Nota_di_creditoHome constructor comment.
 * @param conn java.sql.Connection
 */
public Nota_di_creditoHome(java.sql.Connection conn) {
	
	super(Nota_di_creditoBulk.class,conn);
}
/**
 * Nota_di_creditoHome constructor comment.
 * @param conn java.sql.Connection
 ...
 */
public Nota_di_creditoHome(java.sql.Connection conn, it.cnr.jada.persistency.PersistentCache persistentCache) {
	super(Nota_di_creditoBulk.class, conn, persistentCache);
}
/**
...
public SQLBuilder createSQLBuilder() {
	...
	sql.addSQLClause("AND", "FATTURA_PASSIVA.TI_FATTURA", sql.EQUALS, Nota_di_creditoBulk.TIPO_NOTA_DI_CREDITO);
	return sql;
}
