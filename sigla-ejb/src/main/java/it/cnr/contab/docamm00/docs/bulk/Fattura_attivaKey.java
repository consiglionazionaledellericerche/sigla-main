...
public class Fattura_attivaKey extends OggettoBulk implements KeyedPersistent {
...
public Fattura_attivaKey() {
	super();
}
public Fattura_attivaKey(java.lang.String cd_cds,java.lang.String cd_unita_organizzativa,java.lang.Integer esercizio,java.lang.Long pg_fattura_attiva) {
	super();
	this.cd_cds = cd_cds;
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof Fattura_attivaKey)) return false;
	Fattura_attivaKey k = (Fattura_attivaKey)o;
