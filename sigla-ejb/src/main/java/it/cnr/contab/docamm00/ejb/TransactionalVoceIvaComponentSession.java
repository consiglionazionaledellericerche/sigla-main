...
public class TransactionalVoceIvaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements VoceIvaComponentSession {
public it.cnr.contab.docamm00.tabrif.bulk.Voce_ivaBulk caricaVoceIvaDefault(it.cnr.jada.UserContext param0) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.docamm00.tabrif.bulk.Voce_ivaBulk)invoke("caricaVoceIvaDefault",new Object[] {
			param0 });
...
public boolean validaVoceIva(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.tabrif.bulk.Voce_ivaBulk param1) throws RemoteException {
	try {
		return ((Boolean)invoke("validaVoceIva",new Object[] {
			param0,
			param1 })).booleanValue();
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public java.util.List findListaVoceIVAWS(it.cnr.jada.UserContext userContext, String query,
		String dominio, String tipoRicerca) throws  it.cnr.jada.comp.ComponentException,
		RemoteException {
	try {
		return (java.util.List)invoke("findListaVoceIVAWS",new Object[] {
				userContext,
				query,
				dominio,
				tipoRicerca});
