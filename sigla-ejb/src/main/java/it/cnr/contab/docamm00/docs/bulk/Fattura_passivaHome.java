...
public Timestamp findDataRegFatturaPrecedente( Fattura_passivaBulk fatturaPassiva ) throws PersistencyException, IntrospectionException
{
	...
	sql.addClause("AND", "pg_fattura_passiva", sql.LESS, fatturaPassiva.getPg_fattura_passiva());
...
public Timestamp findDataRegFatturaSuccessiva( Fattura_passivaBulk fatturaPassiva ) throws PersistencyException, IntrospectionException
{
	...
	sql.addClause("AND", "cd_unita_organizzativa", sql.EQUALS, fatturaPassiva.getCd_unita_organizzativa());
	sql.addClause("AND", "esercizio", sql.EQUALS, fatturaPassiva.getEsercizio());
	sql.addClause("AND", "pg_fattura_passiva", sql.GREATER, fatturaPassiva.getPg_fattura_passiva());
