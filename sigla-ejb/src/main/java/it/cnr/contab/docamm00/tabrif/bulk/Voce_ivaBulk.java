...
public class Voce_ivaBulk extends Voce_ivaBase {
	...
	*/
	...
	static {
		...
		naturaOperazioniNonImponibiliKeys.put(NON_SOGGETTE_N2_1,"Non soggette ad IVA ai sensi degli artt. da 7 a 7-septies del DPR 633/72");
		naturaOperazioniNonImponibiliKeys.put(NON_SOGGETTE_N2_2,"Non soggette - altri casi");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI,"Non Imponibili");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI_N3_1,"Non imponibili - esportazioni");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI_N3_2,"Non imponibili - cessioni intracomunitarie");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI_N3_3,"Non imponibili - cessioni verso San Marino");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI_N3_4,"Non imponibili - operazioni assimilate alle cessioni all'esportazione");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI_N3_5,"Non imponibili - a seguito di dichiarazioni d'intento");
		naturaOperazioniNonImponibiliKeys.put(NON_IMPONIBILI_N3_6,"Non imponibili - altre operazioni che non concorrono alla formazione del plafond");
		...
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_1,"Inversione contabile - cessione di rottami e altri materiali di recupero");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_2,"Inversione contabile - cessione di oro e argento puro");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_3,"Inversione contabile - subappalto nel settore edile");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_4,"Inversione contabile - cessione di fabbricati");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_5,"Inversione contabile - cessione di telefoni cellulari");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_6,"Inversione contabile - cessione di prodotti elettronici");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_7,"Inversione contabile - prestazioni comparto edile e settori connessi");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_8,"Inversione contabile - operazioni settore energetico");
		naturaOperazioniNonImponibiliKeys.put(REVERSE_CHARGE_N6_9,"Inversione contabile - altri casi");
