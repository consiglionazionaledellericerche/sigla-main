...
public class DocumentoEleIvaKey extends OggettoBulk implements KeyedPersistent {
	...
	private java.lang.Long progressivoIva;

	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Table name: DOCUMENTO_ELE_IVA
	 **/
	public DocumentoEleIvaKey() {
		super();
	}
	public DocumentoEleIvaKey(java.lang.String idPaese, java.lang.String idCodice, java.lang.Long identificativoSdi, java.lang.Long progressivo, java.lang.Long progressivoIva) {
		super();
	...
	public boolean equalsByPrimaryKey(Object o) {
		...
		if (!(o instanceof DocumentoEleIvaKey)) return false;
		DocumentoEleIvaKey k = (DocumentoEleIvaKey) o;
		...
		if (!compareKey(getProgressivoIva(), k.getProgressivoIva())) return false;
		return true;
	}
	public int primaryKeyHashCode() {
		...
		i = i + calculateKeyHashCode(getProgressivoIva());
		return i;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 ...
	 * Restituisce il valore di: [progressivo]
	 **/
	public void setProgressivoIva(java.lang.Long progressivoIva)  {
		this.progressivoIva=progressivoIva;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Setta il valore di: [progressivo]
	 **/
	public java.lang.Long getProgressivoIva() {
