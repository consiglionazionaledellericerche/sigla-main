...
public class TransactionalTariffarioComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements TariffarioComponentSession {
...
public java.util.List findListaTariffariWS(it.cnr.jada.UserContext param0,String param1,String param2,String param3,String param4) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.util.List)invoke("findListaTariffariWS",new Object[] {
			param0,
			param1,
			param2,
			param3,
