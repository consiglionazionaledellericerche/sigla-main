...
public class TransactionalProgressiviAmmComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements ProgressiviAmmComponentSession {
...
public java.lang.Long getNextPG(it.cnr.jada.UserContext param0,it.cnr.contab.docamm00.docs.bulk.Numerazione_doc_ammBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
