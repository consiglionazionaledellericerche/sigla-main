...
public class TransactionalSezionaleComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements SezionaleComponentSession {
...
public java.util.List findListaSezionaleWS(it.cnr.jada.UserContext userContext, String tipo,String tipo_fattura,
		String uo, String query, String dominio, String tipoRicerca)
		throws it.cnr.jada.comp.ComponentException, RemoteException {
	try {
		return (java.util.List)invoke("findListaSezionaleWS",new Object[] {
				userContext,
				tipo , 
				tipo_fattura,
				uo,
