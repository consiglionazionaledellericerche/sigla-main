...
public class Fattura_passivaKey extends OggettoBulk implements KeyedPersistent {
...
public Fattura_passivaKey() {
	super();
}
public Fattura_passivaKey(java.lang.String cd_cds,java.lang.String cd_unita_organizzativa,java.lang.Integer esercizio,java.lang.Long pg_fattura_passiva) {
	super();
	this.cd_cds = cd_cds;
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof Fattura_passivaKey)) return false;
	Fattura_passivaKey k = (Fattura_passivaKey)o;
