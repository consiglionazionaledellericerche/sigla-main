...
public enum CMISDocAmmAttachment {
	...
	private CMISDocAmmAttachment(String value) {
		this.value = value;
	}
	...
	public static CMISDocAmmAttachment fromValue(String v) {
		for (CMISDocAmmAttachment c : CMISDocAmmAttachment.values()) {
			if (c.value.equals(v)) {
				return c;
			}
		}
