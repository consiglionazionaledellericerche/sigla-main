...
public class DocumentoEleScontoMaggKey extends OggettoBulk implements KeyedPersistent {
	...
	private java.lang.Long progressivoSconto;
	
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Table name: DOCUMENTO_ELE_SCONTO_MAGG
	 **/
	public DocumentoEleScontoMaggKey() {
		super();
	}
	public DocumentoEleScontoMaggKey(java.lang.String idPaese, java.lang.String idCodice, java.lang.Long identificativoSdi, java.lang.Long progressivo, java.lang.Long progressivoSconto) {
		super();
		this.idPaese=idPaese;
		this.idCodice=idCodice;
		this.identificativoSdi=identificativoSdi;
		this.progressivo=progressivo;
		this.progressivoSconto=progressivoSconto;		
	}
	public boolean equalsByPrimaryKey(Object o) {
		if (this== o) return true;
		if (!(o instanceof DocumentoEleScontoMaggKey)) return false;
		DocumentoEleScontoMaggKey k = (DocumentoEleScontoMaggKey) o;
		...
		if (!compareKey(getProgressivoSconto(), k.getProgressivoSconto())) return false;		
		return true;
	}
	public int primaryKeyHashCode() {
		...
		i = i + calculateKeyHashCode(getProgressivoSconto());		
		return i;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	...
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Restituisce il valore di: [progressivoTributo]
	 **/
	public void setProgressivoSconto(java.lang.Long progressivoSconto)  {
		this.progressivoSconto=progressivoSconto;
	}
	/**
	 * Created by BulkGenerator 2.0 [07/12/2009]
	 * Setta il valore di: [progressivoSconto]
	 **/
	public java.lang.Long getProgressivoSconto() {
		return progressivoSconto;
	}		
}