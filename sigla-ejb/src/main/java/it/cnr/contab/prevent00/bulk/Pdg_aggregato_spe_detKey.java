...
public class Pdg_aggregato_spe_detKey extends OggettoBulk implements KeyedPersistent {
...
public Pdg_aggregato_spe_detKey() {
	super();
}
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof Pdg_aggregato_spe_detKey)) return false;
	Pdg_aggregato_spe_detKey k = (Pdg_aggregato_spe_detKey)o;
