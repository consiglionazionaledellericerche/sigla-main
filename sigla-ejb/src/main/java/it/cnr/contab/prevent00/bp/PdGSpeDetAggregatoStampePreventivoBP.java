...
/**
 * Business Process di gestione della stampa dell'aggregato dei piani di gestione parte spese
 */

public class PdGSpeDetAggregatoStampePreventivoBP extends it.cnr.jada.util.action.BulkBP {
public PdGSpeDetAggregatoStampePreventivoBP() {
	super();
}
