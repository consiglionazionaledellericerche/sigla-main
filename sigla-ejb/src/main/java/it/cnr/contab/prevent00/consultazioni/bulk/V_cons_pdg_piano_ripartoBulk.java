 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class V_cons_pdg_piano_ripartoBulk extends OggettoBulk implements Persistent {
	...
	private java.math.BigDecimal importo_da_ripartire;

	public V_cons_pdg_piano_ripartoBulk() {
		super();
	}
	/**
	 * @return
	 ...
	 * @param decimal
	 */
	public void setImporto_assegnato(java.math.BigDecimal decimal) {
		importo_assegnato = decimal;
	}

	/**
	 * @param decimal
	 */
	public void setImporto_da_ripartire(java.math.BigDecimal decimal) {
		importo_da_ripartire = decimal;
	}
