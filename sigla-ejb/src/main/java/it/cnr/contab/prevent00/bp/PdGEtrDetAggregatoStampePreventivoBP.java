...
/**
 * Business Process di gestione della stampa dell'aggregato dei piani di gestione parte entrate
 */

public class PdGEtrDetAggregatoStampePreventivoBP extends it.cnr.jada.util.action.BulkBP {
public PdGEtrDetAggregatoStampePreventivoBP() {
	super();
}
