...
/**
 * Business Process di gestione delle stampe del bilancio preventivo
 */

public class BilancioStampePreventivoCDSBP extends it.cnr.jada.util.action.BulkBP {
public BilancioStampePreventivoCDSBP() {
	super();
}
/**
