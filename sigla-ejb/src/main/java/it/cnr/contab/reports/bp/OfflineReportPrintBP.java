...
public void writeFormField(javax.servlet.jsp.JspWriter out,String name) throws java.io.IOException {
	getBulkInfo().writeFormField(out,getModel(),null,name,"main",1,1,it.cnr.jada.util.action.FormController.EDIT,false,getFieldValidationMap());
}
public void writeFormInput(javax.servlet.jsp.JspWriter out,String name) throws java.io.IOException {
	getBulkInfo().writeFormInput(out,getModel(),null,name,false,null,null,"main",it.cnr.jada.util.action.FormController.EDIT,getFieldValidationMap());
}
