...
public class CRUDAssUnitaOperativaBP extends SimpleCRUDBP{
	...
	private final SimpleDetailCRUDController assUnitaOperativa = new SimpleDetailCRUDController("RepertorioLimiti",Repertorio_limitiBulk.class,"unitaOperativaColl",this);
