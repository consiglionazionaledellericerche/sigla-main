...
public class ParametriSelezioneMovimentiBulk extends AbilitazioneMagazzinoBulk implements KeyedPersistent{
	...
	public java.lang.Integer getAnnoLotto() {
		return annoLotto;
	}

	public void setAnnoLotto(java.lang.Integer annoLotto) {
	...
	public void setDaNumeroOrdine(java.lang.Integer daNumeroOrdine) {
		this.daNumeroOrdine = daNumeroOrdine;
	}

	public java.lang.Integer getaNumeroOrdine() {
