...
import it.cnr.contab.preventvar00.ejb.*;
...
public String getFormTitle() {
	String title = BulkInfo.getBulkInfo(getModel().getClass()).getLongDescription();
    ...
    return "<script>document.write(\""+stringbuffer.toString()+"\")</script>";
}
