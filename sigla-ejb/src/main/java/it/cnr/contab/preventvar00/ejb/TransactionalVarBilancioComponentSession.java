...
public class TransactionalVarBilancioComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements VarBilancioComponentSession {
...
public it.cnr.contab.preventvar00.bulk.Var_bilancioBulk salvaDefinitivo(it.cnr.jada.UserContext param0,it.cnr.contab.preventvar00.bulk.Var_bilancioBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.preventvar00.bulk.Var_bilancioBulk)invoke("salvaDefinitivo",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.preventvar00.bulk.Var_bilancioBulk creaVariazioneBilancioDiRegolarizzazione(it.cnr.jada.UserContext param0, it.cnr.contab.doccont00.core.bulk.MandatoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.preventvar00.bulk.Var_bilancioBulk)invoke("creaVariazioneBilancioDiRegolarizzazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.preventvar00.bulk.Var_bilancioBulk eliminaVariazione(UserContext param0, OggettoBulk param1) throws it.cnr.jada.comp.ComponentException , it.cnr.jada.persistency.PersistencyException, RemoteException{
	try {
		return (it.cnr.contab.preventvar00.bulk.Var_bilancioBulk)invoke("eliminaVariazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
