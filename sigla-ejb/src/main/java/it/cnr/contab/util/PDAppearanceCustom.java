 ...
 */
public class PDAppearanceCustom
{
     ...
     */
    public PDAppearanceCustom( PDAcroForm theAcroForm, PDVariableText field , String fontName) throws IOException
    {
