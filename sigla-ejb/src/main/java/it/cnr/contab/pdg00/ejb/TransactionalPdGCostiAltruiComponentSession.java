...
public class TransactionalPdGCostiAltruiComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements PdGCostiAltruiComponentSession {
