...
byte[] lanciaStampa(it.cnr.jada.UserContext userContext,Integer esercizio,Integer pg_variazione) throws PersistencyException, ComponentException,java.rmi.RemoteException, javax.ejb.EJBException;
}
