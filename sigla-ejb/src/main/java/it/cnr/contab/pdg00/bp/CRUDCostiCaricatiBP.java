...
/**
 * Business Process per la gestione dei Costi Caricati da altra UO
 */

public class CRUDCostiCaricatiBP extends it.cnr.jada.util.action.CRUDListaBP {

	private it.cnr.contab.config00.sto.bulk.CdrBulk centro_responsabilita;

public CRUDCostiCaricatiBP() {
	super();
}

public CRUDCostiCaricatiBP(String function) {
	super(function);
}
 ...
 * @param cdr	
 */
public CRUDCostiCaricatiBP(String function, it.cnr.contab.config00.sto.bulk.CdrBulk cdr) {
	super(function);
...
protected void init(it.cnr.jada.action.Config config,it.cnr.jada.action.ActionContext context) throws it.cnr.jada.action.BusinessProcessException {
	...
	setColumns(getBulkInfo().getColumnFieldPropertyDictionary("costiCaricati"));
}
