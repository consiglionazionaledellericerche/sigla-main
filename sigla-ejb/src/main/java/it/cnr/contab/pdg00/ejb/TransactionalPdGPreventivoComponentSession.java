...
public class TransactionalPdGPreventivoComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements PdGPreventivoComponentSession {
public it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk annullaCDPSuPdg(it.cnr.jada.UserContext param0,it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk)invoke("annullaCDPSuPdg",new Object[] {
			param0,
			param1 });
...
public it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk caricaPdg(it.cnr.jada.UserContext param0,it.cnr.contab.config00.sto.bulk.CdrBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk)invoke("caricaPdg",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk delDetByLA(it.cnr.jada.UserContext param0,it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk param1) throws RemoteException,it.cnr.jada.comp.ApplicationException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk)invoke("delDetByLA",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public boolean isDettagliPdGModificabili(it.cnr.jada.UserContext param0,it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return ((Boolean)invoke("isDettagliPdGModificabili",new Object[] {
			param0,
			param1 })).booleanValue();
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.jada.bulk.OggettoBulk modificaStatoPdG(it.cnr.jada.UserContext param0,it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk param1) throws RemoteException,it.cnr.contab.pdg00.comp.DiscrepanzeAggregatoException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.jada.bulk.OggettoBulk)invoke("modificaStatoPdG",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
		...
		try {
			throw e.getTargetException();
		} catch(it.cnr.contab.pdg00.comp.DiscrepanzeAggregatoException ex) {
			throw ex;
		} catch(it.cnr.jada.comp.ComponentException ex) {
			throw ex;
		} catch(Throwable ex) {
...
public it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk ribaltaCostiPdGArea(it.cnr.jada.UserContext param0,it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk)invoke("ribaltaCostiPdGArea",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk scaricaCDPSuPdg(it.cnr.jada.UserContext param0,it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.pdg00.bulk.Pdg_preventivoBulk)invoke("scaricaCDPSuPdg",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public boolean isUoPrincipale(it.cnr.contab.utenze00.bp.CNRUserContext param0)
	throws it.cnr.jada.comp.ComponentException, java.rmi.RemoteException {
	try {
		return ((Boolean) invoke("isUoPrincipale", new Object[] { param0 }))
			.booleanValue();
	} catch (java.rmi.RemoteException e) {
		throw e;
...
public boolean controllaDiscrepanzeAggregatoForCons(it.cnr.jada.UserContext param0,it.cnr.jada.bulk.OggettoBulk param1, String param2)
	throws it.cnr.jada.comp.ComponentException, java.rmi.RemoteException {
	try {
		return ((Boolean) invoke("controllaDiscrepanzeAggregatoForCons", new Object[] { param0,param1,param2 }))
			.booleanValue();
	} catch (java.rmi.RemoteException e) {
		throw e;
	} catch (InvocationTargetException e) {
