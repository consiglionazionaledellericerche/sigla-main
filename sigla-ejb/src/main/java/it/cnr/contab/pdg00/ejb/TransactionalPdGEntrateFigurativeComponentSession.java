...
public class TransactionalPdGEntrateFigurativeComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements PdGEntrateFigurativeComponentSession {
