...
public class CodiciIvaFattureAcquistiBP extends LiquidazioneIvaAnnualeBP {

	private int status = INSERT;
public CodiciIvaFattureAcquistiBP() {
	this("");
}
public CodiciIvaFattureAcquistiBP(String function) {
	super(function+"Tr");
}
public Liquidazione_iva_annualeVBulk createNewBulk(ActionContext context) throws BusinessProcessException {
	try {
		Codici_iva_fatture_acquistiVBulk bulk = new Codici_iva_fatture_acquistiVBulk();
