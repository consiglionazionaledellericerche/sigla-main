...
public class RiepilogativiProvvisoriIvaBP extends StampaRegistriIvaBP {

	private int status = INSERT;

public RiepilogativiProvvisoriIvaBP() {
	this("");
}

public RiepilogativiProvvisoriIvaBP(String function) {
	super(function+"Tr");
}
 ...
 */
public Riepilogativi_provvisori_ivaVBulk createEmptyModelForSearch(ActionContext context) throws BusinessProcessException {
 ...
 */
public Riepilogativi_provvisori_ivaVBulk createNewBulk(ActionContext context) throws BusinessProcessException {
	try {
		Riepilogativi_provvisori_ivaVBulk bulk = new Riepilogativi_provvisori_ivaVBulk();
		bulk.setUser(context.getUserInfo().getUserid());
		bulk= (Riepilogativi_provvisori_ivaVBulk)bulk.initializeForSearch(this,context);
