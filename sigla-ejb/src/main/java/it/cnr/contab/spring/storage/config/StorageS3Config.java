...
/**
 * Created by mspasiano on 7/3/17.
 */
@Configuration
@Profile("S3")
public class StorageS3Config {
    ...
    public StorageS3Config(S3ConfigurationProperties s3ConfigurationProperties, AmazonS3 amazonS3) {
    ...
    public StorageService storageService() {
        StorageService storageService =  new StorageService() {
            ...
            @Override
            public void init() {
                LOGGER.info("init StorageS3Config....");
            }
        };
        storageService.init();
