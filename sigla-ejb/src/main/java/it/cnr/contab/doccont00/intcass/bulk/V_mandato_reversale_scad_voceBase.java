...
public class V_mandato_reversale_scad_voceBase extends V_mandato_reversale_scad_voceKey implements Keyed {
	...
	public V_mandato_reversale_scad_voceBase() {
		super();
	}
	public V_mandato_reversale_scad_voceBase(Integer esercizio, Integer esercizio_originale, String ti_documento, String cd_cds, String cd_voce, String cd_centro_responsabilita, String cd_linea_attivita, Long pg_documento) {
