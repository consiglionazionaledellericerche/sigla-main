 ...
 * @author: Ilaria Gorla
 */
public class V_mandatoAcc_terzoBulk extends MandatoAccreditamentoBulk {
 ...
 */
public V_mandatoAcc_terzoBulk(String cd_cds, Integer esercizio, Long pg_mandato) {
...
{
	return new MandatoAccreditamentoBulk( getCd_cds(), getEsercizio(), getPg_mandato());
}
/**
 * Insert the method's description here.
 * Creation date: (10/12/2002 14.32.57)
