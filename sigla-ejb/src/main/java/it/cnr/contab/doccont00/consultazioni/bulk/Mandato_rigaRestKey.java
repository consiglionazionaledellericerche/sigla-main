...
public class Mandato_rigaRestKey extends OggettoBulk implements KeyedPersistent {
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof Mandato_rigaRestKey)) return false;
	Mandato_rigaRestKey k = (Mandato_rigaRestKey)o;
