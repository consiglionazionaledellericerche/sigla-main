...
public class MandatoKey extends OggettoBulk implements KeyedPersistent {
...
public MandatoKey(java.lang.String cd_cds,java.lang.Integer esercizio,java.lang.Long pg_mandato) {
	super();
	this.cd_cds = cd_cds;
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof MandatoKey)) return false;
	MandatoKey k = (MandatoKey)o;
