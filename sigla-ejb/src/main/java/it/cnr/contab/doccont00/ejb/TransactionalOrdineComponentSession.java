...
public class TransactionalOrdineComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements OrdineComponentSession {
...
public it.cnr.contab.doccont00.ordine.bulk.OrdineBulk completaTerzo(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.ordine.bulk.OrdineBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.doccont00.ordine.bulk.OrdineBulk)invoke("completaTerzo",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public java.util.List findListabanche(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.ordine.bulk.OrdineBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
