...
public class Mandato_terzoBase extends Mandato_terzoKey implements Keyed {
	// CD_TIPO_BOLLO VARCHAR(5) NOT NULL
	private java.lang.String cd_tipo_bollo;

public Mandato_terzoBase() {
	super();
}
public Mandato_terzoBase(java.lang.String cd_cds,java.lang.Integer cd_terzo,java.lang.Integer esercizio,java.lang.Long pg_mandato) {
