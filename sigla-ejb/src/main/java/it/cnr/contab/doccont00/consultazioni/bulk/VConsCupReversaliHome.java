...
public class VConsCupReversaliHome extends BulkHome {
	public VConsCupReversaliHome(Connection conn) {
		super(VConsCupReversaliBulk.class, conn);
	}
	public VConsCupReversaliHome(Connection conn, PersistentCache persistentCache) {
		super(VConsCupReversaliBulk.class, conn, persistentCache);
	}
