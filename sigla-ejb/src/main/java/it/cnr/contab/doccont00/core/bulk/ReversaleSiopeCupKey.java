...
public class ReversaleSiopeCupKey extends OggettoBulk implements KeyedPersistent {
	...
	public boolean equalsByPrimaryKey(Object o) {
		...
		if (!(o instanceof ReversaleSiopeCupKey)) return false;
		ReversaleSiopeCupKey k = (ReversaleSiopeCupKey) o;
