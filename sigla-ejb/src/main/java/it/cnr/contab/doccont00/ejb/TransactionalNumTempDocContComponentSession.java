...
public class TransactionalNumTempDocContComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements NumTempDocContComponentSession {
...
public java.lang.Long getNextTempPg(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.AccertamentoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
...
public java.lang.Long getNextTempPg(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.ObbligazioneBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.lang.Long)invoke("getNextTempPg",new Object[] {
			param0,
			param1 });
...
public java.lang.Long getNextTempPg(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.Obbligazione_modificaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.lang.Long)invoke("getNextTempPg",new Object[] {
			param0,
			param1 });
...
public java.lang.Long getNextTempPg(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.Accertamento_modificaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (java.lang.Long)invoke("getNextTempPg",new Object[] {
			param0,
			param1 });
