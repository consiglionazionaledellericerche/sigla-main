...
public class TransactionalObbligazionePGiroComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements ObbligazionePGiroComponentSession {
...
public it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk annullaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk)invoke("annullaObbligazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk creaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.AccertamentoPGiroBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk)invoke("creaObbligazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public void eliminaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		invoke("eliminaObbligazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk modificaObbligazione(it.cnr.jada.UserContext param0,it.cnr.contab.doccont00.core.bulk.AccertamentoPGiroBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.doccont00.core.bulk.ImpegnoPGiroBulk)invoke("modificaObbligazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
