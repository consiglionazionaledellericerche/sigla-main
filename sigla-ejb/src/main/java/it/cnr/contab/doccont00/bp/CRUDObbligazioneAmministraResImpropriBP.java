...
public class CRUDObbligazioneAmministraResImpropriBP extends CRUDObbligazioneBP{
    public CRUDObbligazioneAmministraResImpropriBP() {
    }

    public CRUDObbligazioneAmministraResImpropriBP(String function) {
        super(function);
    }
