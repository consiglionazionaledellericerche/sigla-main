...
public class MandatoCupKey extends OggettoBulk implements KeyedPersistent {
	...
	public boolean equalsByPrimaryKey(Object o) {
		...
		if (!(o instanceof MandatoCupKey)) return false;
		MandatoCupKey k = (MandatoCupKey) o;
