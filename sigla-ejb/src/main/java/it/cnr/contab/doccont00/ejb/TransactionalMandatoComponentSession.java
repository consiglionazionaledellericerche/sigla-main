...
public class TransactionalMandatoComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements MandatoComponentSession {
	...
	@Override
	public Boolean esisteAnnullodaRiemettereNonCollegato(
			UserContext param0, Integer param1, String param2)
			throws ComponentException, RemoteException {
		try {
	...
	@Override
	public Boolean isMandatoCollegatoAnnullodaRiemettere(
			UserContext param0, MandatoBulk param1)
			throws ComponentException, RemoteException {
		try {
