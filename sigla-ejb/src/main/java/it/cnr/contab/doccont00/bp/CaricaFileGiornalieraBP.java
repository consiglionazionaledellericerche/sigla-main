...
import it.cnr.contab.doccont00.intcass.giornaliera.FlussoGiornaleDiCassa;
...
import it.cnr.contab.doccont00.intcass.giornaliera.ObjectFactory;
...
//			if (sess.getVal03( actioncontext.getUserContext(),it.cnr.contab.utenze00.bulk.CNRUserInfo.getEsercizio(actioncontext), null, "COSTANTI", "FORMATO_FLUSSO_BANCA") != null)				
//					versioneflussoGiornaliera = sess.getVal03(actioncontext.getUserContext(),it.cnr.contab.utenze00.bulk.CNRUserInfo.getEsercizio(actioncontext), null, "COSTANTI", "FORMATO_FLUSSO_BANCA");
//			else
//				throw new ApplicationException("Configurazione mancante versione Flusso Giornaliera");
//			
//			if ( versioneflussoGiornaliera.compareTo("1")==0 ){
				jc = JAXBContext
...
//		    else{
//		    	?
//				jc = JAXBContext.newInstance("it.gov.agenziaentrate.ivaservizi.docs.xsd.fatture.v2");
//		    	
//				ObjectFactory obj = new ObjectFactory();
//				b=(it.cnr.contab.doccont00.intcass.giornaliera.FlussoGiornaleDiCassa)jc.createUnmarshaller().unmarshal(file);
//			}
