...
public class V_impegnoKey extends OggettoBulk {
...
public V_impegnoKey( String cd_cds, Integer esercizio, Integer esercizio_originale, Long pg_obbligazione, Long pg_obbligazione_scadenzario ) 
{	super();
	this.cd_cds = cd_cds;
...
public boolean equalsByPrimaryKey(Object o) {
	...
	if (!(o instanceof V_impegnoKey)) return false;
	V_impegnoKey k = (V_impegnoKey)o;
