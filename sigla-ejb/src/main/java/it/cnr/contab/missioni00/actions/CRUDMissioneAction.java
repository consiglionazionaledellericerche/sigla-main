...
public Forward doBringBackCRUDCrea_terzo(ActionContext context, MissioneBulk missione, V_terzo_per_compensoBulk aTerzo) throws java.rmi.RemoteException 
{
	return doBringBackSearchFind_terzo(context, missione, aTerzo);
}
...
public Forward doOnBancaChange(ActionContext context) 
{
	try
	{
		...
		try{missione.isCompensoModificabile();}
...
public Forward doOnFineMissioneChange(ActionContext context)
{
	...
	try 
	{
		...
		try{bp.checkValiditaInizioFineMissione(context);}
...
public Forward doOnInizioMissioneChange(ActionContext context) 
{
	try 
	{
		...
		try{missione.isDataInizioModificabile();}
		catch(it.cnr.jada.comp.ApplicationException e)
		{
...
public Forward doOnIstituzionaleCommercialeChange(ActionContext context) 
{
	try
	{
		...
		try{missione.isIstituzionaleCommercialeModificabile();}
		catch(it.cnr.jada.comp.ApplicationException e)
		{	
...
public Forward doRiportaAvanti(ActionContext context) throws java.rmi.RemoteException 
{
	...
	catch(Throwable e) 
	{
		...
		catch(BusinessProcessException v){return handleException(context,v);}
...
public Forward doSearchFind_terzo(ActionContext context) 
{
	try 
	{
		...
		{
			OptionBP option = openConfirm(context,"I dettagli della missione verranno cancellati. Proseguire ??",OptionBP.CONFIRM_YES_NO,"doConfermaTerzoSearchChange");
			return option;			
		}
	} 
	catch (Throwable t) 
