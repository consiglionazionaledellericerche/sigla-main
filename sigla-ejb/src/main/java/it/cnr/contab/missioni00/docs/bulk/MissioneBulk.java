...
public boolean isCompensoDaModificareInAutomatico() 
{
	...
	if(missioneIniziale.getTermini_pagamento() == null)
		missioneIniziale.setTermini_pagamento(new Rif_termini_pagamentoBulk());		

	if(	!getModalita_pagamento().equalsByPrimaryKey(missioneIniziale.getModalita_pagamento()) ||
		!getBanca().equalsByPrimaryKey(missioneIniziale.getBanca()) ||
		!getTermini_pagamento().equalsByPrimaryKey(missioneIniziale.getTermini_pagamento()))
	{
