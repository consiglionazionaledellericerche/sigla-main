...
public class Missione_rigaBulk extends Missione_rigaBase {
	...
	public Missione_rigaBulk(java.lang.String cd_cds, java.lang.String cd_unita_organizzativa, java.lang.Integer esercizio,
			java.lang.Long pg_missione, java.lang.Long progressivo_riga) {
		super(cd_cds, cd_unita_organizzativa, esercizio, pg_missione, progressivo_riga);
		this.setMissione(new MissioneBulk(cd_cds, cd_unita_organizzativa, esercizio, pg_missione));
	}
