...
public interface IMissioneTipoPastoMgr extends it.cnr.jada.comp.ICRUDMgr
{
 ...
 *
**/
public abstract Missione_tipo_pastoBulk gestioneNazione(UserContext userContext, Missione_tipo_pastoBulk bulk) throws ComponentException;
}
