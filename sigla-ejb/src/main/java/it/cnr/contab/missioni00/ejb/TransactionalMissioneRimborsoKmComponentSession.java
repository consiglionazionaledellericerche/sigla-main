...
public class TransactionalMissioneRimborsoKmComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements MissioneRimborsoKmComponentSession {
...
public it.cnr.contab.missioni00.tabrif.bulk.Missione_rimborso_kmBulk gestioneNazione(it.cnr.jada.UserContext param0,it.cnr.contab.missioni00.tabrif.bulk.Missione_rimborso_kmBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.missioni00.tabrif.bulk.Missione_rimborso_kmBulk)invoke("gestioneNazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
