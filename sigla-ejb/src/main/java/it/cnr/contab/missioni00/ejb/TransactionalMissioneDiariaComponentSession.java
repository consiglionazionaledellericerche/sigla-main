...
public class TransactionalMissioneDiariaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements MissioneDiariaComponentSession {
...
public it.cnr.contab.missioni00.tabrif.bulk.Missione_diariaBulk gestioneNazione(it.cnr.jada.UserContext param0,it.cnr.contab.missioni00.tabrif.bulk.Missione_diariaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.missioni00.tabrif.bulk.Missione_diariaBulk)invoke("gestioneNazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
