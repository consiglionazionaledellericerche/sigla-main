...
public class TransactionalMissioneAbbattimentiComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements MissioneAbbattimentiComponentSession {
...
public it.cnr.contab.missioni00.tabrif.bulk.Missione_abbattimentiBulk gestioneNazione(it.cnr.jada.UserContext param0,it.cnr.contab.missioni00.tabrif.bulk.Missione_abbattimentiBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.missioni00.tabrif.bulk.Missione_abbattimentiBulk)invoke("gestioneNazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
