...
public class TransactionalMissioneTipoPastoComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements MissioneTipoPastoComponentSession {
...
public it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_pastoBulk gestioneNazione(it.cnr.jada.UserContext param0,it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_pastoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_pastoBulk)invoke("gestioneNazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
...
public it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_pastoBulk gestioneAreePaesiEsteri(it.cnr.jada.UserContext param0,it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_pastoBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_pastoBulk)invoke("gestioneAreePaesiEsteri",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
