...
public class TransactionalMissioneTipoSpesaComponentSession extends it.cnr.jada.ejb.TransactionalCRUDComponentSession implements MissioneTipoSpesaComponentSession {
...
public it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_spesaBulk gestioneNazione(it.cnr.jada.UserContext param0,it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_spesaBulk param1) throws RemoteException,it.cnr.jada.comp.ComponentException {
	try {
		return (it.cnr.contab.missioni00.tabrif.bulk.Missione_tipo_spesaBulk)invoke("gestioneNazione",new Object[] {
			param0,
			param1 });
	} catch(java.rmi.RemoteException e) {
		throw e;
